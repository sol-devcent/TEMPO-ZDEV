...
PARAMETERS: r02 RADIOBUTTON GROUP r1 USER-COMMAND us1.
SELECTION-SCREEN COMMENT 3(30) text-004 FOR FIELD r02.
*PARAMETERS: c01 AS CHECKBOX.
*SELECTION-SCREEN COMMENT 36(30) text-005 FOR FIELD c01.
...
SELECTION-SCREEN COMMENT 3(31) text-006 FOR FIELD r10.
SELECTION-SCREEN END OF LINE.

PARAMETERS: r11 RADIOBUTTON GROUP r1, "MODIF ID nds,
            r12 RADIOBUTTON GROUP r1. "MODIF ID nds.
...
*      CONDENSE p_start.
    ...
    WHEN r11.
      CONCATENATE 'WEB' p_vkorg p_vkbur INTO p_start SEPARATED BY '_'.
      CONDENSE p_start.
      SUBMIT zsfafi_i006 WITH p_start = p_start
                         WITH p_back = 'X'
                         AND RETURN.

    WHEN r12.
      SUBMIT zsfafi_e006 VIA SELECTION-SCREEN AND RETURN
                         WITH p_vkorg = p_vkorg
                         WITH p_vkbur = p_vkbur.
