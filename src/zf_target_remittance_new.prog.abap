...
* Begin remark unicode coversion - DEVK965007
* 25.02.2020 - sol iway
...
* End remark unicode coversion - DEVK965007
* Begin insert unicode conversion - DEVK965007
* 25.02.2020 - sol iway
DATA: i_itabtc_real TYPE TABLE OF t_itab WITH HEADER LINE.
* End insert unicode conversion - DEVK965007
...
SELECTION-SCREEN : COMMENT 5(52) text-019 FOR FIELD radio8.
SELECTION-SCREEN END OF LINE.
...
*added by idub 20050920
  ...
  IF radio8 = 'X' AND sy-ucomm = space.
...
** Req by SJT 07/01/2014
** Sementara tdk baca ZFTOP, va_act = 100
...
*      ENDIF.
      va_act  = 75.
      IF wa_itab-bukrs = '8070'.
        l_top = 16.
      ENDIF.
** End req by SJT 07/01/2014
    ...
    LOOP AT i_result8_real INTO wa_result.
      ...
      SELECT SINGLE bezei
        ...
        WHERE kvgr3 EQ wa_result-kvgr3 AND
            ( spras EQ 'EN' OR spras EQ 'E' ).
      CONCATENATE wa_result-kvgr3 l_bezei
          INTO l3_text SEPARATED BY '-'.
      CONCATENATE 'Real :' l3_text
          INTO l3_text SEPARATED BY space.
      WRITE AT c1(w1) va_nou NO-GAP. c1 = c1 + w1.
