...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zmr_kemenkes NO STANDARD PAGE HEADING
                    LINE-SIZE 520.                          "490.
...
PARAMETERS: p_bpom RADIOBUTTON GROUP grp1 USER-COMMAND usr MODIF ID nds,
            p_depkes RADIOBUTTON GROUP grp1 DEFAULT 'X' MODIF ID nds.
