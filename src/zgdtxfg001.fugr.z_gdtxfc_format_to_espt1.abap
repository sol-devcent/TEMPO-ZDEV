FUNCTION z_gdtxfc_format_to_espt1.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* Add by Budi 22/02/2011
      fe_espt-flagvat = '0'.
      fe_espt-npwp255 = fe_espt-kodenpwp.
      fe_espt-nodok = fi_zgdtxst0012-fakturno1.
      IF fi_zgdtxst0012-credit = 'R'.   "nota retur
        fe_espt-jenisdok = '1'.
        fe_espt-fakturganti = fi_zgdtxst0012-fakturno1.
        fe_espt-jenisganti = '1'.
      ELSE.
        fe_espt-jenisdok = '0'.
      ENDIF.
      CONCATENATE fe_espt-kodemstx fe_espt-kodemstx INTO fe_espt-masapjk.
      fe_espt-pembetulan = fe_espt-koreksi.
...
* Add by Budi 22/02/2011
      fe_espt-flagvat = '0'.
      fe_espt-npwp255 = fe_espt-kodenpwp.
      fe_espt-nodok = fi_zgdtxst0013-fakturno1.
      IF fe_espt-kodedok = '2'.                                 "Nota Retur
        fe_espt-jenisdok = '1'.
        fe_espt-fakturganti = fi_zgdtxst0013-fakturno1.
        fe_espt-jenisganti = '1'.
      ELSE.
        fe_espt-jenisdok = '0'.
      ENDIF.
