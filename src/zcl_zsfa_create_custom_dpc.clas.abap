class ZCL_ZSFA_CREATE_CUSTOM_DPC definition
  public
...
protected section.
  ...
  methods CUSTOMERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZSFA_CREATE_CUSTOM_MPC=>TS_CUSTOMER
    raising
  ...
  methods CUSTOMERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZSFA_CREATE_CUSTOM_MPC=>TT_CUSTOMER
...
CLASS ZCL_ZSFA_CREATE_CUSTOM_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 08.12.2025 16:57:02 in client 800
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZSFA_CREATE_CUSTOM_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA customerset_create_entity TYPE zcl_zsfa_create_custom_mpc=>ts_customer.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA customerset_get_entity TYPE zcl_zsfa_create_custom_mpc=>ts_customer.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZSFA_CREATE_CUSTOM_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA customerset_get_entityset TYPE zcl_zsfa_create_custom_mpc=>tt_customer.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA customerset_update_entity TYPE zcl_zsfa_create_custom_mpc=>ts_customer.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
