class ZCL_ZDMP_POST_ORDER_MPC definition
  public
...
TT_ORDER type standard table of TS_ORDER .
  ...
  begin of TS_OPERATION,
     ...
     ROOMS type C length 10,
     DATES type C length 8,
     TIMES type C length 8,
...
TT_MATERIAL type standard table of TS_MATERIAL .
  types:
  begin of TS_HANDOVERFLAG,
     AUFNR type C length 12,
     VORNR type C length 4,
     ACTWH type C length 4,
     CNTR type C length 10,
     AUFNR_ORI type C length 12,
  end of TS_HANDOVERFLAG .
  types:
TT_HANDOVERFLAG type standard table of TS_HANDOVERFLAG .
  types:
  begin of TS_MATERIALFLAG,
     AUFNR type C length 12,
     VORNR type C length 4,
     POSNR type C length 4,
     MATNR type C length 18,
     WEMPF type C length 12,
     ZEILE type C length 5,
     CHARG type C length 10,
     ACTWH type C length 4,
  ...
  end of TS_MATERIALFLAG .
  types:
TT_MATERIALFLAG type standard table of TS_MATERIALFLAG .
  types:
  begin of TS_MATERIALFLAG2,
     AUFNR type C length 12,
     VORNR type C length 4,
     POSNR type C length 4,
     MATNR type C length 18,
     ...
     ACTWH type C length 4,
     WADAH type C length 2,
  end of TS_MATERIALFLAG2 .
  types:
TT_MATERIALFLAG2 type standard table of TS_MATERIALFLAG2 .

  constants GC_HANDOVERFLAG type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'HandoverFlag' ##NO_TEXT.
  constants GC_MATERIAL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Material' ##NO_TEXT.
  constants GC_MATERIALFLAG type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'MaterialFlag' ##NO_TEXT.
  constants GC_MATERIALFLAG2 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'MaterialFlag2' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZDMP_POST_ORDER_MPC=======CP' ##NO_TEXT.
  ...
  methods DEFINE_MATERIAL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_HANDOVERFLAG
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_MATERIALFLAG
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_MATERIALFLAG2
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZDMP_POST_ORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZDMP_POST_ORDER_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'HandoverFlag' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'OriginalOrder' iv_abap_fieldname = 'AUFNR_ORI' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_HANDOVERFLAG' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HandoverFlagSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StartDate' iv_abap_fieldname = 'DATES' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'StartTime' iv_abap_fieldname = 'TIMES' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_MATERIAL' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'MaterialFlag' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FullpackItem' iv_abap_fieldname = 'ZEILE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_MATERIALFLAG' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'MaterialFlagSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - MaterialFlag2
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'MaterialFlag2' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_MATERIALFLAG2' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'MaterialFlag2Set' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_OPERATION' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZDMP_POST_ORDER_MPC=>TS_ORDER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251211100924'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'OrderNo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HandoverFlag'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'OriginalOrder'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HandoverFlag'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'OrderNo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'MaterialFlag'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'FullpackItem'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'MaterialFlag'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'OrderNo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'MaterialFlag2'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
