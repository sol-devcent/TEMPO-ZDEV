...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zf_gspost_stm NO STANDARD PAGE HEADING
                      LINE-SIZE 255.
...
SELECT-OPTIONS so_buda1  FOR zfgsdnstm-budat MODIF ID bu1.
SELECT-OPTIONS so_buda2  FOR zfgsdnstm-budat MODIF ID bu2.
SELECT-OPTIONS so_zgsno  FOR zfgscab-zgsno MODIF ID zgs.
SELECT-OPTIONS so_nodn   FOR zfgsdnstm-nomordn MODIF ID ndn.
