...
public section.
  ...
  methods SET_DEFAULT_EXCEL_DATE_FORMAT
    ...
    raising
      ZCX_EXCEL .
  class ZCL_EXCEL_COMMON definition load .
  methods SET_MERGE
    importing
...
* Zeichen einer
* Zahl enthalten sind. Das ist fÃ¼r Timestamps, die auch ":" enthalten.
* FÃ¼r die
...
*    lv_value = <ls_field_catalog>-scrtext_m.
    ...
    IF <ls_field_catalog>-cfieldname IS NOT INITIAL.
      lv_value = <ls_field_catalog>-cfieldname.
    ENDIF.
...
method GET_CELL.
  ...
  " Addition to solve issue #120, contribution by Stefan Schm#ÃƒÂƒÃ¢Â€ÂžÃƒÂ‚Ã¢Â€ÂšÃƒÂƒÃ¢Â€ÂšÃƒÂ‚Ã¢Â€ÂšÃƒÂƒÃ¢Â€ÂžÃƒÂ‚Ã¢Â€ ÃƒÂƒÃ¢Â€ÂšÃƒÂ‚Ã¢Â€Â™ÃƒÂƒÃ¢Â€ÂžÃƒÂ‚Ã¢Â€ÂšÃƒÂƒÃ¢Â€ÂšÃƒÂ‚Ã†Â’ÃƒÂƒÃ†Â’ÃƒÂ‚Ã‚Â¢ÃƒÂƒÃ¢Â€ÂšÃƒÂ‚Ã¢Â‚Â¬ÃƒÂƒÃ¢Â€ÂšÃƒÂ‚Ã…Â¡#cker
...
*--------------------------------------------------------------------*
* ToDos:
*        2do Â§1  The current coding for replacing a named ranges name
...
*--------------------------------------------------------------------*
* 2do Â§1  -  Check if the following quickfix is solid
