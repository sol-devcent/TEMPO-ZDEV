class ZCL_ZDMP_GET_ORDER2_DPC definition
  public
...
protected section.
  ...
  methods WEIGHINGACTSET_UPDATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_WEIGHINGACT
    raising
  ...
  methods WEIGHINGACTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_WEIGHINGACT
  ...
  methods WADAHSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_WADAH
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods WADAHSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_WADAH
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ORDERSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_ORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_ORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods OPRCONFSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_OPRCONF
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods OPRCONFSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_OPRCONF
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods OPERATIONTYPESET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_OPERATIONTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods OPERATIONTYPESET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_OPERATIONTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods OPERATIONSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_OPERATION
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods OPERATIONSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_OPERATION
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods OPERATIONDESCSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_OPERATIONDESC
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods OPERATIONDESCSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_OPERATIONDESC
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods MATERIALSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZDMP_GET_ORDER2_MPC=>TS_MATERIAL
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods MATERIALSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZDMP_GET_ORDER2_MPC=>TT_MATERIAL
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZDMP_GET_ORDER2_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 16.12.2024 16:41:21 in client 800
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZDMP_GET_ORDER2_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA operationdescset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationdesc.
 DATA orderset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_order.
 DATA operationtypeset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationtype.
 DATA materialset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_material.
 DATA operationset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operation.
 DATA wadahset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_wadah.
 DATA oprconfset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_oprconf.
 DATA weighingactset_create_entity TYPE zcl_zdmp_get_order2_mpc=>ts_weighingact.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA orderset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_order.
 DATA operationdescset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationdesc.
 DATA operationtypeset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationtype.
 DATA operationset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operation.
 DATA materialset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_material.
 DATA wadahset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_wadah.
 DATA weighingactset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_weighingact.
 DATA oprconfset_get_entity TYPE zcl_zdmp_get_order2_mpc=>ts_oprconf.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZDMP_GET_ORDER2_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA orderset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_order.
 DATA oprconfset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_oprconf.
 DATA operationdescset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_operationdesc.
 DATA weighingactset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_weighingact.
 DATA wadahset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_wadah.
 DATA operationtypeset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_operationtype.
 DATA materialset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_material.
 DATA operationset_get_entityset TYPE zcl_zdmp_get_order2_mpc=>tt_operation.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA materialset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_material.
 DATA operationset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operation.
 DATA wadahset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_wadah.
 DATA operationtypeset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationtype.
 DATA orderset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_order.
 DATA oprconfset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_oprconf.
 DATA operationdescset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_operationdesc.
 DATA weighingactset_update_entity TYPE zcl_zdmp_get_order2_mpc=>ts_weighingact.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
