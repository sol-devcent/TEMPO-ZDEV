FUNCTION ZQDRS2_FIXED_SQRT_LOTQTY.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* Initialisierungen.
  ...
  FIELD-SYMBOLS: <fs_losmenge> TYPE qals-losmenge.
  ASSIGN ('(SAPLQPL1)QALS-LOSMENGE') TO <fs_losmenge>.
...
* Modification:
  ...
  IF <fs_losmenge> = 1.
    I_QDSV_STPRUMF = 1.
  ELSEIF <fs_losmenge> = 2.
    I_QDSV_STPRUMF = 2.
  ELSE.
    I_QDSV_STPRUMF = CEIL( SQRT( <fs_losmenge> ) ) + 1.
  ENDIF.
