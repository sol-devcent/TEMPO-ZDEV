...
PARAMETERS:
  p_nama(40) OBLIGATORY DEFAULT sy-uname,
...
*------------------------------------------------------*
  ...
  WHERE ( profl = 'OKT' OR PROFL EQ 'PSI' )
...
FORM cetak.
  ...
  CONCATENATE va_ort01 ',' INTO lv_kota.
  WRITE sy-datum TO lv_datum DD/MM/YYYY.
  CONCATENATE lv_kota lv_datum INTO lv_kota SEPARATED BY space.
    ...
    ON CHANGE OF wa_all-matnr.
      ...
      ELSE.
        IF sy-linno GE 55.
          ...
          WRITE:/143 lv_kota. "va_ort01, ',', sy-datum.
          IF p_werks EQ '0200'.
