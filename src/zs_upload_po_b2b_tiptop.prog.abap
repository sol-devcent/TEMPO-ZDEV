...
PARAMETERS: p_path(125) DEFAULT '\\tdsdev01\interface2\b2b\tiptop' LOWER CASE,
            p_start(10),
...
*}   REPLACE
    ...
    CONCATENATE v_logfile '/' sy-datum(4) '/' sy-datum+4(2) '/tiptop' INTO v_logfile.
  ELSE.
    ...
    CONCATENATE v_logfile '\' sy-datum(4) '\' sy-datum+4(2) '\tiptop' INTO v_logfile.
  ENDIF.
...
*                                       wa_itab_h-nama_toko.
        ...
        wa_itab_h-po_no     = wa_itab-ztext+41(9).
        wa_itab_h-po_date   = wa_itab-ztext+50(8).
        wa_itab_h-exp_date  = wa_itab-ztext+191(8).
...
** Move To itab Update
        ...
        CONCATENATE wa_itab-ztext+101(3) 'PO' wa_itab-ztext+41(9)
        INTO i_zsh_b2b-ebeln
        SEPARATED BY '.'.
        i_zsh_b2b-bedat    = wa_itab-ztext+50(8).
        i_zsh_b2b-bnddt    = wa_itab-ztext+191(8).
        i_zsh_b2b-patner   = wa_itab-ztext+101(10).
        ...
        i_b2blog-zpono     = wa_itab-ztext+41(9).
        i_b2blog-bedat     = wa_itab-ztext+50(8).
...
*      wa_itab_d-plu       = wa_itab-ztext+9(6).
      wa_itab_d-plu       = wa_itab-ztext+147(11).
      wa_itab_d-qty       = wa_itab-ztext+50(9).
      wa_itab_d-harga     = wa_itab-ztext+59(11).
      wa_itab_d-bonus1    = wa_itab-ztext+94(7).
      SHIFT wa_itab_d-qty LEFT DELETING LEADING '0'.
      SHIFT wa_itab_d-harga LEFT DELETING LEADING '0'.
      SHIFT wa_itab_d-bonus1 LEFT DELETING LEADING space.
