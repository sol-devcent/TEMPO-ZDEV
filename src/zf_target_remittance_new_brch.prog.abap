REPORT zf_target_remittance_new_brch MESSAGE-ID zf NO STANDARD PAGE HEADING
                                     LINE-SIZE 262.
...
TABLES: knvv, bsid, knvk, vrkpa, tgsb, tgsbt, kna1, vbpa, tvkol,
        t151, t151t, pa0001, t001, tvbur, tvkbt, ztgtsls, zproject, vbrk.
...
DATA: BEGIN OF i_result11 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        vkbur LIKE tvbur-vkbur,
        kdgrp LIKE knvv-kdgrp,
        brsch LIKE kna1-brsch,
        ...
        target TYPE p,
        actual TYPE p,
        persen TYPE p DECIMALS 4,
      END OF i_result11.

DATA: BEGIN OF i_result41 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        kdgrp LIKE knvv-kdgrp,
        vkbur LIKE tvbur-vkbur,
        brsch LIKE kna1-brsch,
...
DATA: BEGIN OF i_result101 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        kvgr3 LIKE knvv-kvgr3,
        vkbur LIKE tvbur-vkbur,
        brsch LIKE kna1-brsch,
...
DATA: BEGIN OF i_result61 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        brsch LIKE kna1-brsch,
        kdgrp LIKE knvv-kdgrp,
        vkbur LIKE tvbur-vkbur,
...
DATA: BEGIN OF i_result81 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        vkbur LIKE tvbur-vkbur,
        channel LIKE zfchanel-channel,
        kdgrp LIKE knvv-kdgrp,
...
DATA: BEGIN OF i_result91 OCCURS 0,
        bukrs LIKE bsid-bukrs,
        vkbur LIKE tvbur-vkbur,
        channel LIKE zfchanel-channel,
        kdgrp LIKE knvv-kdgrp,
...
DATA: BEGIN OF t_result20 OCCURS 0,
        vkbur TYPE vkbur,
        bezei TYPE bezei20,
        kunnr LIKE bsid-kunnr,
        name1 LIKE kna1-name1,
        ...
        waerk LIKE ztgtsls-waerk,
        value LIKE ztgtsls-value,
        pydat LIKE bsid-bldat,
        pyval LIKE ztgtsls-value,
      END OF t_result20.

DATA: BEGIN OF t_result22 OCCURS 0,
        vkbur TYPE vkbur,
        bezei TYPE bezei20,
        kunnr LIKE bsid-kunnr,
        name1 LIKE kna1-name1,
...
DATA: i_itab TYPE t_itab OCCURS 0,
      ...
      t_result20_real LIKE t_result20 OCCURS 0 WITH HEADER LINE,
      t_result22_real LIKE t_result22 OCCURS 0 WITH HEADER LINE,
...
* added by idub 20050922
      ...
      i_result9 TYPE t_result OCCURS 0,
      i_result10 TYPE t_result OCCURS 0,
...
* added by idub 20050922
      ...
      i_zfarea LIKE zfarea OCCURS 0 WITH HEADER LINE,
      i_result7_real TYPE t_result OCCURS 0,
      i_result82 LIKE i_result81 OCCURS 0 WITH HEADER LINE,
      i_result82tc LIKE i_result81 OCCURS 0 WITH HEADER LINE,
      i_result8_real TYPE t_result OCCURS 0,
      i_result92 LIKE i_result81 OCCURS 0 WITH HEADER LINE,
      i_result92tc LIKE i_result81 OCCURS 0 WITH HEADER LINE,
      i_result9_real TYPE t_result OCCURS 0,
      i_result10_real TYPE t_result OCCURS 0,
*
...
*
      ...
      wa_result20 LIKE t_result20,
      wa_result22 LIKE t_result22,
      wa_total TYPE t_result,
      wa_total_real TYPE t_result.

TYPES: BEGIN OF t_kunn2,
...
DATA: i_kunn2 TYPE t_kunn2 OCCURS 0,
      wa_kunn2 TYPE t_kunn2,
      i_pernr TYPE t_kunn2 OCCURS 0,
      wa_pernr TYPE t_kunn2.

*DATA: BEGIN OF i_kunn2 OCCURS 0 ,
*        kunnr LIKE knvp-kunnr,
*        vkorg LIKE knvp-vkorg,
*        parvw LIKE knvp-parvw,
*        kunn2 LIKE knvp-kunn2,
...
DATA:  va_nou TYPE i,
       ...
       va_texttotal1(30),
       va_texttotal2(30),
       va_channel LIKE zfchanel-channel,
       char4(4),
       char8(8),
       va_flag(1),
       va_project(1)  ,
...
DATA: gt_tvkbt TYPE TABLE OF tvkbt WITH HEADER LINE.
...
* Sementara NO-DISPLAY karena permintaan SJT 12/12/2005
                ...
                s_fkart FOR vbrk-fkart MODIF ID pfk.
...
SELECTION-SCREEN : COMMENT 5(55) text-101 FOR FIELD radio17.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio18 RADIOBUTTON GROUP grp1.
SELECTION-SCREEN : COMMENT 5(45) text-104 FOR FIELD radio18.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio19 RADIOBUTTON GROUP grp1.
SELECTION-SCREEN : COMMENT 5(55) text-105 FOR FIELD radio19.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio20 RADIOBUTTON GROUP grp1.
SELECTION-SCREEN : COMMENT 5(45) text-103 FOR FIELD radio20.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio22 RADIOBUTTON GROUP grp1.
SELECTION-SCREEN : COMMENT 5(45) text-107 FOR FIELD radio22.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio23 RADIOBUTTON GROUP grp1.
SELECTION-SCREEN : COMMENT 5(79) text-108 FOR FIELD radio23.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio21 RADIOBUTTON GROUP grp1 MODIF ID sut.
SELECTION-SCREEN : COMMENT 5(45) text-106 FOR FIELD radio21.
SELECTION-SCREEN END OF LINE.
*SELECTION-SCREEN BEGIN OF LINE.
*PARAMETERS : radio18 RADIOBUTTON GROUP grp1.
...
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio10 RADIOBUTTON GROUP grp3 DEFAULT 'X' MODIF ID hid.
SELECTION-SCREEN : COMMENT 5(22) text-098 FOR FIELD radio10.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio11 RADIOBUTTON GROUP grp3 MODIF ID hid.
SELECTION-SCREEN : COMMENT 5(22) text-097 FOR FIELD radio11.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio12 RADIOBUTTON GROUP grp3 MODIF ID hid.
SELECTION-SCREEN : COMMENT 5(22) text-096 FOR FIELD radio12.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio13 RADIOBUTTON GROUP grp3 MODIF ID hid.
SELECTION-SCREEN : COMMENT 5(22) text-095 FOR FIELD radio13.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio14 RADIOBUTTON GROUP grp3 MODIF ID hid.
SELECTION-SCREEN : COMMENT 5(22) text-094 FOR FIELD radio14.
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS : radio15 RADIOBUTTON GROUP grp3 MODIF ID hid.
...
*    IF l_date+6(2) >= 25.
*      IF l_uzeit(2) >= 09 AND  l_uzeit(2) < 15.
*        MESSAGE w010(zf). " WITH 'Mohon dijalankan diluar jam 09:00 s.d 15:00'.
**        LEAVE PROGRAM.
*      ENDIF.
*    ENDIF.
**  ENDIF.
...
INITIALIZATION.
  REFRESH: i_result, i_result1, i_result2, i_result3, i_result4,
         i_result5, i_result6, i_target, i_itab.
...
*    IF l_date+6(2) >= 25.
*      IF l_uzeit(2) >= 09 AND  l_uzeit(2) < 15.
*        MESSAGE w010(zf). " WITH 'Mohon dijalankan secara backgroud'.
*        LEAVE PROGRAM.
*        EXIT.
*      ENDIF.
*    ENDIF.
...
*  ENDIF.
  ...
  REFRESH: i_result, i_result1, i_result2, i_result3, i_result4,
         i_result5, i_result6, i_result10, i_target, i_itab.

  CLEAR: i_result1, i_result2, i_result3, i_result4,
         i_result5, i_result6, i_result7, i_result10, i_target.
...
**** perform selanjutnya
  ...
  SELECT * INTO TABLE i_zfarea FROM zfarea
    WHERE vkbur IN so_gsber.
...
AT USER-COMMAND.
  IF i_result1 IS INITIAL OR
     ...
     i_result8 IS INITIAL OR
     i_result9 IS INITIAL OR
     i_result10 IS INITIAL.
  ELSE.
...
*    PERFORM f_write_header_column USING 'Branch'.
    v_title2 = 'A/R Target & Actual Remittance Per Branch (National)'.
    PERFORM f_write_header2.
    PERFORM f_write_header_column2 USING 'Branch'.
  ENDIF.

*  IF radio2 = 'X' AND sy-ucomm = space.
...
*  ENDIF.
  ...
  IF radio4 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target Remittance Per Customer Group (National)'.
*    PERFORM f_write_header1.
*    PERFORM f_write_header_column USING 'Customer Group'.
    PERFORM f_write_header12.
    PERFORM f_write_header_column12 USING 'Customer Group'.
  ENDIF.

  IF radio21 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target Remittance Per Sub Customer Group'.
*    PERFORM f_write_header1.
*    PERFORM f_write_header_column USING 'Customer Group'.
    PERFORM f_write_header12.
    PERFORM f_write_header_column12 USING 'Sub Customer Group'.
  ENDIF.
...
*added by idub 20050920
  IF radio16 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target Remittance Per Branch and Industry (National)'.
*    PERFORM f_write_header1.
*    PERFORM f_write_header_column USING 'Branch and Industry'.
    PERFORM f_write_header12.
    PERFORM f_write_header_column12 USING 'Industry'.
  ENDIF.

  IF radio17 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target Remittance Per National and Channel'.
  ...
  IF radio19 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target Remittance Per Branch and Channel (Summary)'.
    PERFORM f_write_header11.
    PERFORM f_write_header_column1.
  ENDIF.

  IF radio20 = 'X' AND sy-ucomm = space.
    v_title2 = 'A/R Target & Actual Remittance Per DN'.
    PERFORM f_write_header11.
    PERFORM f_write_header_column8.
  ENDIF.

  IF ( radio22 = 'X' OR radio23 = 'X' ) AND sy-ucomm = space.
    CASE 'X'.
      WHEN radio22.
        v_title2 = 'A/R Target & Actual Remittance Per DN & Bill.Type'.
      WHEN radio23.
        v_title2 = 'A/R Target & Actual Remittance Per DN & Bill.Type – Tempo Trading'.
    ENDCASE.
    PERFORM f_write_header11.
    PERFORM f_write_header_column9.
  ENDIF.
...
*    PERFORM f_write_header_column USING 'Branch and Industry'.
  ...
  IF sy-ucomm = 'CHANNEL'.
    v_title2 = 'A/R Target Remittance Per Nasional and Channel'.
    PERFORM f_write_header11.
    PERFORM f_write_header_column1.
  ENDIF.

  IF sy-ucomm = 'BRCH_CHANL'.
    v_title2 = 'A/R Target Remittance Per Branch and Channel'.
    PERFORM f_write_header11.
    PERFORM f_write_header_column1.
  ENDIF.

  IF sy-ucomm = 'SUM_CHANL'.
    v_title2 = 'A/R Target Remittance Per Branch and Channel (Summary)'.
    PERFORM f_write_header11.
    PERFORM f_write_header_column1.
  ENDIF.
  ...
  IF sy-ucomm = 'DNFKART' OR sy-ucomm = '05T'.
    CASE sy-ucomm.
      WHEN 'DNFKART'.
        v_title2 = 'A/R Target & Actual Remittance Per DN & Bill.Type'.
      WHEN '05T'.
...
*&---------------------------------------------------------------------*
FORM f_proses1.
  DATA: ld_areanm LIKE zfarea-areanm,
        ld_brchnm LIKE zfarea-brchnm,
        ld_total_tgt LIKE wa_result-total_r,
        ld_total_tgt1 LIKE wa_result-total_r,
        ld_total_act LIKE wa_result-total_r,
        ld_total_act1 LIKE wa_result-total_r,
        ld_persen TYPE p DECIMALS 4.
...
* Completed itab
    CLEAR: wa_total,wa_total_real.
    SORT i_result1 BY vkbur.
    SORT i_result1_real BY vkbur.
    LOOP AT i_result1 INTO wa_result.
      i_result11-bukrs = pa_bukrs.
      i_result11-vkbur = wa_result-vkbur.
      i_result11-target = wa_result-total_r.
      COLLECT i_result11. CLEAR i_result11.
    ENDLOOP.
    LOOP AT i_result1_real INTO wa_total_real.
      i_result11-bukrs = pa_bukrs.
      i_result11-vkbur = wa_total_real-vkbur.
      i_result11-actual = wa_total_real-total_r.
      COLLECT i_result11. CLEAR i_result11.
    ENDLOOP.
  ENDIF.

* cetak
*  CLEAR: va_nou,wa_total,wa_total_real.
*  SORT i_result11 BY vkbur.
*  SORT i_result1 BY vkbur.
*  SORT i_result1_real BY vkbur.
*  SORT i_zfarea BY area gsber vkbur.
*  LOOP AT i_zfarea.
*    LOOP AT i_result1 INTO wa_result
*      WHERE vkbur = i_zfarea-vkbur.
*
*      IF sy-tabix GT 1 AND i_zfarea-brchnm IS NOT INITIAL AND
*        i_zfarea-brchnm NE ld_brchnm.
*        PERFORM f_cetak_subtotal_kosong.
*      ENDIF.
*
*      SELECT SINGLE *
*        FROM tvkbt
...
*
*      CONCATENATE wa_result-vkbur tvkbt-bezei INTO va_text SEPARATED BY '-'.
*      ADD 1 TO va_nou.
*      c1 = 1.
*      WRITE: /  sy-vline.
*      c1 = c1 + 1.
...
*      c1 = c1 + w3.
**    Cetak Realization
*      READ TABLE i_result1_real INTO wa_result_real
*        WITH KEY vkbur = wa_result-vkbur BINARY SEARCH.
*
*      wa_result_real-total_r = wa_result_real-total_r * -1.
*      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
*      WRITE AT c1(w3) wa_result_real-total_r ROUND va_round NO-GAP.
*      c1 = c1 + w3.
**    Cetak Persen
*      IF wa_result-total_r IS INITIAL.
*        ld_persen = 0.
*      ELSE.
*        ld_persen = wa_result_real-total_r / wa_result-total_r * 100.
*      ENDIF.
*      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
*      WRITE AT c1(w3) ld_persen DECIMALS 2.
*      c1 = c1 + w3.
*      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
*      c1 = 0.
**    Hitung Total
*      ADD wa_result-total_r TO wa_total-total_r.
*      ADD wa_result-total_r TO ld_total_tgt.
*      ADD wa_result_real-total_r TO wa_total_real-total_r.
*      ADD wa_result_real-total_r TO ld_total_act.
*      IF i_zfarea-brchnm IS NOT INITIAL.
*        ADD wa_result-total_r TO ld_total_tgt1.
*        ADD wa_result_real-total_r TO ld_total_act1.
*      ENDIF.
*      ld_areanm = i_zfarea-areanm.
*      ld_brchnm = i_zfarea-brchnm.
*      CLEAR: wa_result,wa_result_real,ld_persen.
*    ENDLOOP.
  CLEAR: va_nou,wa_total,wa_total_real.
  SORT i_result11 BY vkbur.
  SORT i_result1 BY vkbur.
  ...
  SORT i_zfarea BY area gsber vkbur.
  LOOP AT i_zfarea.
    LOOP AT i_result11 WHERE vkbur = i_zfarea-vkbur.
      ...
      SELECT SINGLE *
        FROM tvkbt
        WHERE vkbur EQ i_result11-vkbur AND
            ( spras EQ 'EN' OR spras EQ 'E' ).

      CONCATENATE i_result11-vkbur tvkbt-bezei INTO va_text SEPARATED BY '-'.
      ADD 1 TO va_nou.
      c1 = 1.
      WRITE: /  sy-vline.
      c1 = c1 + 1.
      ...
      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
      SET LEFT SCROLL-BOUNDARY.
      WRITE AT c1(w3) i_result11-target ROUND va_round NO-GAP.
      c1 = c1 + w3.
      i_result11-actual = i_result11-actual * -1.
      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
      WRITE AT c1(w3) i_result11-actual ROUND va_round NO-GAP.
      c1 = c1 + w3.
*    Cetak Persen
      IF i_result11-target IS INITIAL.
        ld_persen = 0.
      ELSE.
        ld_persen = i_result11-actual / i_result11-target * 100.
      ENDIF.
      WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
      WRITE AT c1(w3) ld_persen DECIMALS 2.
      c1 = c1 + w3.
      ...
      c1 = 0.
*    Hitung Total
      ADD i_result11-target TO wa_total-total_r.
      ADD i_result11-target TO ld_total_tgt.
      ADD i_result11-actual TO wa_total_real-total_r.
      ADD i_result11-actual TO ld_total_act.
      IF i_zfarea-brchnm IS NOT INITIAL.
        ADD i_result11-target TO ld_total_tgt1.
        ADD i_result11-actual TO ld_total_act1.
      ENDIF.
      ld_areanm = i_zfarea-areanm.
      ld_brchnm = i_zfarea-brchnm.
      CLEAR: i_result11,wa_result,wa_result_real,ld_persen.
    ENDLOOP.
    AT END OF gsber.
      IF ld_brchnm IS NOT INITIAL.
        PERFORM f_cetak_subtotal_gsber USING ld_brchnm
                                             ld_total_tgt1
                                             ld_total_act1.
        CLEAR: ld_total_tgt1,ld_total_act1,ld_brchnm.
      ELSE.
*        PERFORM f_cetak_subtotal_kosong.
      ENDIF.
    ENDAT.
    AT END OF area.
      PERFORM f_cetak_subtotal_area USING ld_areanm
                                          ld_total_tgt
                                          ld_total_act.
      CLEAR: ld_total_tgt,ld_total_act,ld_areanm.
      CLEAR: ld_total_tgt1,ld_total_act1,ld_brchnm.
    ENDAT.
  ENDLOOP.

*  Cetak Grand Total
  IF wa_total-total_r IS INITIAL.
    ld_persen = 0.
  ELSE.
    ld_persen = wa_total_real-total_r / wa_total-total_r * 100.
  ENDIF.
  WRITE: / sy-uline(86).
  c1 = 1.
  WRITE: /  sy-vline.
...
* cetak
  ...
  IF pa_real EQ 'X' AND
    pa_targe EQ space.
    SORT i_result2_real BY bukrs vkbur kunnr.
    ...
    ENDLOOP.
  ELSE.
    SORT i_result2 BY bukrs vkbur kunnr.
    SORT i_result2_real BY bukrs vkbur kunnr.
...
FORM f_proses4.
  ...
  DATA: lv_totalnas(100).

  IF pa_bukrs = '8020'.
    lv_totalnas = 'Total PT.TEMPO NASIONAL'.
  ELSEIF pa_bukrs = '8070'.
    lv_totalnas = 'Total PT.SUT NASIONAL'.
  ENDIF.

  IF lt_t151t[] IS INITIAL.
    SELECT * INTO TABLE lt_t151t
     FROM t151t
  ...
  IF i_result41[] IS INITIAL.
    IF i_result4[] IS INITIAL.
      SORT i_itab BY bukrs kdgrp vkbur.
...
*    IF pa_real EQ 'X'.
    IF i_result4_real[] IS INITIAL.
      SORT i_itab_real BY bukrs kdgrp vkbur.
...
*    ENDIF.
    ...
    IF i_result41[] IS INITIAL.
      LOOP AT lt_t151t .
        CLEAR: i_result41.
        i_result41-bukrs = pa_bukrs.
        i_result41-kdgrp = lt_t151t-kdgrp.
        LOOP AT i_result4 INTO wa_result WHERE bukrs = i_result41-bukrs AND
                                               kdgrp = i_result41-kdgrp.
          CLEAR: i_result41-target.
          i_result41-vkbur = wa_result-vkbur.
          i_result41-target = wa_result-total_r.
          COLLECT i_result41.
          CLEAR: i_result41-target.
        ENDLOOP.
        LOOP AT i_result4_real INTO wa_result WHERE bukrs = i_result41-bukrs AND
                                                    kdgrp = i_result41-kdgrp.
          CLEAR: i_result41-actual.
          i_result41-vkbur = wa_result-vkbur.
          i_result41-actual = wa_result-total_r.
          COLLECT i_result41.
          CLEAR: i_result41-actual.
        ENDLOOP.
      ENDLOOP.
...
* cetak
  SORT i_result41 BY bukrs kdgrp vkbur.
  LOOP AT i_result41.
    AT NEW kdgrp.
      CLEAR lt_t151t.
      READ TABLE lt_t151t WITH KEY kdgrp = i_result41-kdgrp.
      CONCATENATE i_result41-kdgrp lt_t151t-ktext
        INTO va_text SEPARATED BY '-'.
      va_texttotal2 = va_text.
    ENDAT.

    AT NEW vkbur.
      SELECT SINGLE *  FROM tvkbt
        WHERE vkbur EQ i_result41-vkbur AND
            ( spras EQ 'EN' OR spras EQ 'E' ).
      CONCATENATE i_result41-vkbur tvkbt-bezei
        INTO l4_text SEPARATED BY '-'.
    ENDAT.

    i_result41-actual = i_result41-actual * -1.
    IF i_result41-target EQ 0.
      i_result41-persen = 0.
    ELSE.
      i_result41-persen = i_result41-actual / i_result41-target * 100.
    ENDIF.
    WRITE:/ '|', va_text(30), '|',
            l4_text(30), '|',
            i_result41-target ROUND va_round, '|',
            i_result41-actual ROUND va_round, '|',
            i_result41-persen DECIMALS 2, '|'.
    CLEAR va_text.

    AT END OF kdgrp.
      SUM.
      i_result41-actual = ABS( i_result41-actual ).
      IF i_result41-target EQ 0.
        i_result41-persen = 0.
      ELSE.
        i_result41-persen = i_result41-actual / i_result41-target * 100.
      ENDIF.
      PERFORM f_write_kosong2.
      WRITE:/ '|',
           34 '|', va_texttotal2(30), '|',
              i_result41-target ROUND va_round, '|',
              i_result41-actual ROUND va_round, '|',
...
*         l_tmp1(4) TYPE n.
  ...
  SORT i_zfchanel BY bukrs vkbur kdgrp.
  SORT i_itab BY bukrs vkbur kdgrp.
  LOOP AT i_itab INTO wa_itab.
...
FORM f_proses6.
  DATA: l_kunnr(10),
        l_name1 LIKE kna1-name1,
        ld_sw(1),
        lt_t016t LIKE t016t OCCURS 0 WITH HEADER LINE.
  ...
  IF lt_t016t[] IS INITIAL.
    SELECT * INTO TABLE lt_t016t
     FROM t016t
     WHERE spras = sy-langu  AND
           brsch IN so_brsch.
  ENDIF.
  ...
  IF i_result61[] IS INITIAL.
    IF i_result6[] IS INITIAL.
      SORT i_itab BY bukrs brsch vkbur.
...
*    IF pa_real EQ 'X'.
    IF i_result6_real[] IS INITIAL.
      SORT i_itab_real BY bukrs brsch vkbur.
      CLEAR: wa_itab_real, wa_result_real, i_result6_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        ON CHANGE OF wa_itab_real-bukrs OR
                     wa_itab_real-brsch OR
                     wa_itab_real-vkbur.
...
*    ENDIF.
    ...
    IF i_result61[] IS INITIAL.
      LOOP AT i_result6 INTO wa_result.
        CLEAR: i_result61-target.
        i_result61-bukrs = pa_bukrs.
        i_result61-brsch = wa_result-brsch.
        i_result61-vkbur = wa_result-vkbur.
        i_result61-target = wa_result-total_r.
        COLLECT i_result61.
        CLEAR: i_result61-target.
      ENDLOOP.
      LOOP AT i_result6_real INTO wa_result.
        CLEAR: i_result61-actual.
        i_result61-bukrs = pa_bukrs.
        i_result61-brsch = wa_result-brsch.
        i_result61-vkbur = wa_result-vkbur.
        i_result61-actual = wa_result-total_r.
        COLLECT i_result61.
        CLEAR: i_result61-actual.
      ENDLOOP.
    ENDIF.
...
* cetak
  SORT i_result61 BY bukrs brsch vkbur.
  LOOP AT i_result61.
    AT NEW brsch.
      CLEAR lt_t016t.
      READ TABLE lt_t016t WITH KEY brsch = i_result61-brsch.
      CONCATENATE i_result61-brsch lt_t016t-brtxt
        INTO va_text SEPARATED BY '-'.
      va_texttotal2 = va_text.
    ENDAT.
    ...
    AT NEW vkbur.
      SELECT SINGLE *  FROM tvkbt
        WHERE vkbur EQ i_result61-vkbur AND
            ( spras EQ 'EN' OR spras EQ 'E' ).
      CONCATENATE i_result61-vkbur tvkbt-bezei
        INTO l6_text SEPARATED BY '-'.
    ENDAT.

    i_result61-actual = i_result61-actual * -1.
    IF i_result61-target EQ 0.
      i_result61-persen = 0.
    ELSE.
      i_result61-persen = i_result61-actual / i_result61-target * 100.
    ENDIF.
    WRITE:/ '|', va_text(30), '|',
            l6_text(30), '|',
            i_result61-target ROUND va_round, '|',
            i_result61-actual ROUND va_round, '|',
            i_result61-persen DECIMALS 2, '|'.
    CLEAR va_text.
...
FORM f_proses71.
  ...
  IF pa_bukrs = '8020'.
    lv_totalnas = 'Total PT.TEMPO NASIONAL'.
    lv_totaltempo = 'Total Tempo'.
  ELSEIF pa_bukrs = '8070'.
    lv_totalnas = 'Total PT.SUT NASIONAL'.
    lv_totaltempo = 'Total SUT'.
  ENDIF.
  ...
  IF va_flag IS INITIAL.
    ...
    IF i_result7[] IS INITIAL.
      SORT i_itab BY bukrs channel kdgrp vkbur.
      CLEAR: wa_itab, wa_result, i_result7.
      LOOP AT i_itab INTO wa_itab.
        ON CHANGE OF wa_itab-bukrs OR
                     wa_itab-channel OR
...
*  IF pa_real EQ 'X'.
    IF i_result7_real[] IS INITIAL.
      SORT i_itab_real BY bukrs channel kdgrp vkbur.
      CLEAR: wa_itab_real, wa_result_real, i_result7_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        ON CHANGE OF wa_itab_real-bukrs OR
                     wa_itab_real-channel OR
...
* cetak
    ...
    SORT i_result71 BY bukrs channel kdgrp vkbur.
    LOOP AT i_result71.
      AT NEW bukrs.
*        va_text = 'Total Tempo'.
        va_text = lv_totaltempo.
      ENDAT.
      AT NEW channel.
      ...
      i_result71-actual = i_result71-actual * -1.
...
*             42 '|', 'Total PT.TEMPO NASIONAL',
  ...
  ELSE.
    ...
    IF i_result7[] IS INITIAL.
      SORT i_itab BY bukrs channel brsch vkbur.
      CLEAR: wa_itab, wa_result, i_result7.
      LOOP AT i_itab INTO wa_itab.
        ON CHANGE OF wa_itab-bukrs OR
                     wa_itab-channel OR
    ...
    IF i_result7_real[] IS INITIAL.
      SORT i_itab_real BY bukrs channel brsch vkbur.
      CLEAR: wa_itab_real, wa_result_real, i_result7_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        ON CHANGE OF wa_itab_real-bukrs OR
                     wa_itab_real-channel OR
...
* cetak
    ...
    SORT i_result71 BY bukrs channel brsch vkbur.
    LOOP AT i_result71.
      AT NEW bukrs.
*        va_text = 'Total Tempo'.
        va_text = lv_totaltempo.
  ...
  IF va_flag IS INITIAL.
    ...
    IF i_result8[] IS INITIAL.
      ...
      LOOP AT i_itab INTO wa_itab.
        ...
        CLEAR: i_result82.
        i_result82-bukrs = wa_itab-bukrs.
        i_result82-vkbur = wa_itab-vkbur.
        i_result82-channel = wa_itab-channel.
        i_result82-kdgrp = wa_itab-kdgrp.
        i_result82-kunnr = wa_itab-kunnr.
        i_result82-target = wa_itab-dmbtr + wa_itab-value.
        COLLECT i_result82.
        CLEAR: i_result82.
...
*  IF pa_real EQ 'X'.
    IF i_result8_real[] IS INITIAL.
      ...
      LOOP AT i_itab_real INTO wa_itab_real.
        ...
        CLEAR: i_result82.
        i_result82-bukrs = wa_itab_real-bukrs.
        i_result82-vkbur = wa_itab_real-vkbur.
        i_result82-channel = wa_itab_real-channel.
        i_result82-kdgrp = wa_itab_real-kdgrp.
        i_result82-kunnr = wa_itab_real-kunnr.
        i_result82-actual = wa_itab_real-dmbtr.
        COLLECT i_result82.
        CLEAR: i_result82.
    ...
    IF i_result81[] IS INITIAL.
      LOOP AT i_zfchanel.
        CLEAR: i_result81, i_result82.
        i_result81-bukrs = i_zfchanel-bukrs.
        i_result81-vkbur = i_zfchanel-vkbur.
        i_result81-channel = i_zfchanel-channel.
        i_result81-kdgrp = i_zfchanel-kdgrp.
        COLLECT i_result81.
      ENDLOOP.
      LOOP AT i_result81.
        LOOP AT i_result8 INTO wa_result WHERE bukrs = i_result81-bukrs AND
                                               vkbur = i_result81-vkbur  AND
                                               channel = i_result81-channel AND
                                               kdgrp = i_result81-kdgrp.
          CLEAR: i_result81-target.
          i_result81-target = wa_result-total_r.
          COLLECT i_result81.
          CLEAR: i_result81-target.
        ENDLOOP.
        LOOP AT i_result8_real INTO wa_result WHERE bukrs = i_result81-bukrs AND
                                                    vkbur = i_result81-vkbur AND
                                                    channel = i_result81-channel AND
                                                    kdgrp = i_result81-kdgrp.
          CLEAR: i_result81-actual.
          i_result81-actual = wa_result-total_r.
          COLLECT i_result81.
          CLEAR: i_result81-actual.
        ENDLOOP.
      ENDLOOP.
...
* cetak
    ...
    SORT i_result81 BY bukrs vkbur channel kdgrp.
    LOOP AT i_result81.
      AT NEW vkbur.
        SELECT SINGLE *
          FROM tvkbt
          WHERE vkbur EQ i_result81-vkbur AND
              ( spras EQ 'EN' OR spras EQ 'E' ).
        CONCATENATE i_result81-vkbur tvkbt-bezei
          INTO va_text SEPARATED BY '-'.
        CONCATENATE 'Total' va_text
          INTO va_texttotal1 SEPARATED BY space.
      ENDAT.
      AT NEW channel.
        CONCATENATE 'Total' i_result81-channel
          INTO va_texttotal2 SEPARATED BY space.
      ENDAT.
      AT NEW kdgrp.
        SELECT SINGLE *
          FROM t151t
          WHERE kdgrp EQ i_result81-kdgrp AND
              ( spras EQ 'EN' OR spras EQ 'E' ).
        CONCATENATE i_result81-kdgrp t151t-ktext
          INTO l8_text SEPARATED BY '-'.
      ENDAT.

      i_result81-actual = i_result81-actual * -1.
      IF i_result81-target EQ 0.
        i_result81-persen = 0.
      ELSE.
        i_result81-persen = i_result81-actual / i_result81-target * 100.
      ENDIF.
      WRITE:/ '|', va_text(30), '|',
              i_result81-channel(5), '|',
              l8_text(30) HOTSPOT, '|',
              i_result81-target ROUND va_round, '|',
              i_result81-actual ROUND va_round, '|',
              i_result81-persen DECIMALS 2, '|'.
  ...
  ELSE.
    ...
    IF i_result8[] IS INITIAL.
      ...
      LOOP AT i_itab INTO wa_itab.
        ...
        i_result82-vkbur = wa_itab-vkbur.
        i_result82-channel = wa_itab-channel.
        i_result82-brsch = wa_itab-brsch.
        i_result82-kunnr = wa_itab-kunnr.
        i_result82-actual = wa_itab-dmbtr.
        COLLECT i_result82.
    ...
    IF i_result8_real[] IS INITIAL.
      ...
      LOOP AT i_itab_real INTO wa_itab_real.
        ...
        i_result82-vkbur = wa_itab_real-vkbur.
        i_result82-channel = wa_itab_real-channel.
        i_result82-brsch = wa_itab_real-brsch.
        i_result82-kunnr = wa_itab_real-kunnr.
        i_result82-target = wa_itab_real-dmbtr.
        COLLECT i_result82.
    ...
    IF i_result81[] IS INITIAL.
      LOOP AT i_zfchanel.
        ...
        i_result81-vkbur = i_zfchanel-vkbur.
        i_result81-channel = i_zfchanel-channel.
        i_result81-brsch = i_zfchanel-brsch.
        COLLECT i_result81.
      ENDLOOP.
      LOOP AT i_result81.
        LOOP AT i_result8 INTO wa_result WHERE bukrs = i_result81-bukrs AND
...
* cetak
    ...
    SORT i_result81 BY bukrs vkbur channel brsch.
    LOOP AT i_result81.
      AT NEW vkbur.
        SELECT SINGLE *
          FROM tvkbt
      ...
      AT NEW brsch.
        SELECT SINGLE brtxt
          FROM t016t
          INTO wa_result-name1
          WHERE brsch EQ i_result81-brsch AND
                spras EQ sy-langu.
        CONCATENATE i_result81-brsch wa_result-name1
          INTO l8_text SEPARATED BY '-'.
      ENDAT.
...
FORM f_proses91.
  ...
  IF va_flag IS INITIAL.
    ...
    IF i_result9[] IS INITIAL.
      SORT i_itab BY bukrs vkbur channel kdgrp.
      CLEAR: wa_itab, wa_result, i_result9.
      LOOP AT i_itab INTO wa_itab.
        ON CHANGE OF wa_itab-bukrs OR
                     wa_itab-vkbur OR
                     wa_itab-channel OR
        ...
        CLEAR: i_result92.
        i_result92-bukrs = wa_itab-bukrs.
        i_result92-vkbur = wa_itab-vkbur.
        i_result92-channel = wa_itab-channel.
        i_result92-kdgrp = wa_itab-kdgrp.
        i_result92-kunnr = wa_itab-kunnr.
        i_result92-target = wa_itab-dmbtr + wa_itab-value.
        COLLECT i_result92.
        CLEAR: i_result92.
...
*  IF pa_real EQ 'X'.
    IF i_result9_real[] IS INITIAL.
      SORT i_itab_real BY bukrs vkbur channel kdgrp.
      CLEAR: wa_itab_real, wa_result_real, i_result9_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        ON CHANGE OF wa_itab_real-bukrs OR
                     wa_itab_real-vkbur OR
                     wa_itab_real-channel OR
          ...
          IF wa_result_real-channel NE space.
            ...
            wa_result_real-total_r = wa_result_real-week1 +
                                     ...
                                     wa_result_real-week5 +
                                     wa_result_real-sales1.
            APPEND wa_result_real TO i_result9_real.
            CLEAR wa_result_real.
          ENDIF.
        ENDON.
        MOVE wa_itab_real-vkbur TO wa_result_real-vkbur.
        ...
        CLEAR: i_result92.
        i_result92-bukrs = wa_itab_real-bukrs.
        i_result92-vkbur = wa_itab_real-vkbur.
        i_result92-channel = wa_itab_real-channel.
        i_result92-kdgrp = wa_itab_real-kdgrp.
        i_result92-kunnr = wa_itab_real-kunnr.
        i_result92-actual = wa_itab_real-dmbtr.
        COLLECT i_result92.
        CLEAR: i_result92.
    ...
    IF i_result91[] IS INITIAL.
      LOOP AT i_zfchanel.
        CLEAR: i_result91, i_result92.
        i_result91-bukrs = i_zfchanel-bukrs.
        i_result91-vkbur = i_zfchanel-vkbur.
        i_result91-channel = i_zfchanel-channel.
        i_result91-kdgrp = i_zfchanel-kdgrp.
        COLLECT i_result91.
      ENDLOOP.
      LOOP AT i_result91.
        LOOP AT i_result9 INTO wa_result WHERE bukrs = i_result91-bukrs AND
                                               vkbur = i_result91-vkbur  AND
                                               channel = i_result91-channel AND
                                               kdgrp = i_result91-kdgrp.
          CLEAR: i_result91-target.
          i_result91-target = wa_result-total_r.
          COLLECT i_result91.
          CLEAR: i_result91-target.
        ENDLOOP.
        LOOP AT i_result9_real INTO wa_result WHERE bukrs = i_result91-bukrs AND
                                                    vkbur = i_result91-vkbur AND
                                                    channel = i_result91-channel AND
                                                    kdgrp = i_result91-kdgrp.
          CLEAR: i_result91-actual.
          i_result91-actual = wa_result-total_r.
          COLLECT i_result91.
          CLEAR: i_result91-actual.
        ENDLOOP.
      ENDLOOP.
...
* cetak
    ...
    SORT i_result91 BY bukrs vkbur channel kdgrp.
    LOOP AT i_result91.
      AT NEW vkbur.
        SELECT SINGLE *
          FROM tvkbt
          WHERE vkbur EQ i_result91-vkbur AND
              ( spras EQ 'EN' OR spras EQ 'E' ).
        CONCATENATE i_result91-vkbur tvkbt-bezei
          INTO va_text SEPARATED BY '-'.
        CONCATENATE 'Total' va_text
          INTO va_texttotal1 SEPARATED BY space.
      ENDAT.
      AT NEW channel.
        va_channel = i_result91-channel.
        CONCATENATE 'Total' i_result91-channel
          INTO va_texttotal2 SEPARATED BY space.
      ENDAT.
*      AT NEW kdgrp.
*        SELECT SINGLE *
*          FROM t151t
*          WHERE kdgrp EQ i_result91-kdgrp AND
*              ( spras EQ 'EN' OR spras EQ 'E' ).
*        CONCATENATE i_result91-kdgrp t151t-ktext
*          INTO l8_text SEPARATED BY '-'.
*      ENDAT.

      i_result91-actual = i_result91-actual * -1.
      IF i_result91-target EQ 0.
        i_result91-persen = 0.
      ELSE.
        i_result91-persen = i_result91-actual / i_result91-target * 100.
      ENDIF.
*      WRITE:/ '|', va_text(30), '|',
*              i_result91-channel(5), '|',
*              l8_text(30) HOTSPOT, '|',
*              i_result91-target ROUND va_round, '|',
*              i_result91-actual ROUND va_round, '|',
*              i_result91-persen DECIMALS 2, '|'.
  ...
  ELSE.
    ...
    IF i_result9[] IS INITIAL.
      ...
      LOOP AT i_itab INTO wa_itab.
        ...
        i_result92-vkbur = wa_itab-vkbur.
        i_result92-channel = wa_itab-channel.
        i_result92-brsch = wa_itab-brsch.
        i_result92-kunnr = wa_itab-kunnr.
        i_result92-actual = wa_itab-dmbtr.
        COLLECT i_result92.
    ...
    IF i_result9_real[] IS INITIAL.
      ...
      LOOP AT i_itab_real INTO wa_itab_real.
        ...
        i_result92-vkbur = wa_itab_real-vkbur.
        i_result92-channel = wa_itab_real-channel.
        i_result92-brsch = wa_itab_real-brsch.
        i_result92-kunnr = wa_itab_real-kunnr.
        i_result92-target = wa_itab_real-dmbtr.
        COLLECT i_result92.
    ...
    IF i_result91[] IS INITIAL.
      LOOP AT i_zfchanel.
        ...
        i_result91-vkbur = i_zfchanel-vkbur.
        i_result91-channel = i_zfchanel-channel.
        i_result91-brsch = i_zfchanel-brsch.
        COLLECT i_result91.
      ENDLOOP.
      LOOP AT i_result91.
        LOOP AT i_result9 INTO wa_result WHERE bukrs = i_result91-bukrs AND
...
* cetak
    ...
    SORT i_result91 BY bukrs vkbur channel brsch.
    LOOP AT i_result91.
      AT NEW vkbur.
        SELECT SINGLE *
          FROM tvkbt
...
*          FROM t016t
*          INTO wa_result-name1
*          WHERE brsch EQ i_result91-brsch AND
*                spras EQ sy-langu.
*        CONCATENATE i_result91-brsch wa_result-name1
*          INTO l8_text SEPARATED BY '-'.
*      ENDAT.
...
*&---------------------------------------------------------------------*
*&      Form  f_write_header_column2
*&---------------------------------------------------------------------*
FORM f_write_header_column2 USING ptext LIKE kna1-name1.
  ...
  WRITE: /  sy-vline.
  c1 = c1 + 1.
  WRITE AT c1(w1) 'No.' CENTERED NO-GAP. c1 = c1 + w1.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w2) ptext CENTERED NO-GAP. c1 = c1 + w2.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) 'Target' CENTERED NO-GAP. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) 'Actual' CENTERED NO-GAP. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) '%' CENTERED. c1 = c1 + w3.
  ...
  c1 = c1 + w2.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) 'Remittance' CENTERED NO-GAP. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) 'Collection' CENTERED NO-GAP. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP..
  c1 = 1.
  ...
  WRITE: / sy-uline(86).
ENDFORM.                    " f_write_header_column2
...
FORM f_write_header2.
  ...
  CONCATENATE sy-tcode sy-uname date time INTO l_tcode
    SEPARATED BY '/'.

  c1 = 0.
  WRITE AT c1(ls) v_title1. c1 = c1 + ls.
  c1 = 0.
  WRITE AT /c1(ls) v_title2. c1 = c1 + ls.
  c1 = 0.
  WRITE AT /c1(ls) v_title3. c1 = c1 + ls.
  c1 = 0.
  WRITE AT /c1(40) l_tcode. c1 = c1 + 40.
  SKIP.
...
*  <--  p2        text
*----------------------------------------------------------------------*
FORM f_write_header_column12 USING ptext.
  WRITE: / sy-uline(125).
  WRITE:/ '|', (30) ptext CENTERED,
          '|', (30) 'Branch' CENTERED,
          '|', (16) 'Target' CENTERED,
          '|', (16) 'Actual' CENTERED,
          '|', (17) '%' CENTERED,
          '|'.
  WRITE: / sy-uline(125).
ENDFORM.                    " f_write_header_column12
...
FORM f_write_header12 .
  ...
  WRITE AT c1(h1) 'Report  :' INTENSIFIED OFF. c1 = c1 + h1.
  WRITE AT c1(h2) v_repid. c1 = c1 + h2.
  WRITE (62) v_title1 CENTERED. c1 = c1 + ls.
  WRITE: 102 'Date    :' INTENSIFIED OFF,
             sy-datum DD/MM/YYYY.
  ...
  WRITE AT /c1(h1) 'Cli/Sys :' INTENSIFIED OFF. c1 = c1 + h1.
  WRITE AT c1(h2) l_cli. c1 = c1 + h2.
  WRITE (62) v_title2 CENTERED. c1 = c1 + ls.
  WRITE: 102 'Time    :' INTENSIFIED OFF,
             sy-uzeit.
...
*  WRITE AT c1(h2) sy-uname. c1 = c1 + h2.
  ...
  WRITE AT c1(3) ' / '. c1 = c1 + 3.
  WRITE AT c1(h1) sy-tcode. c1 = c1 + h1.
  WRITE (62) v_title3 CENTERED. c1 = c1 + ls.
  WRITE: 102 'Page    :' INTENSIFIED OFF,
             sy-pagno.
ENDFORM.                    " f_write_header12
  ...
  IF t_zfarsoff_dele[] IS NOT INITIAL.
    ...
    LOOP AT i_itab_sap INTO wa_itab.
      ...
      IF sy-subrc EQ 0.
        DELETE i_itab_sap.
      ELSE.
        wa_kunn2-kunnr = wa_itab-kunnr.
        wa_kunn2-vkorg = pa_bukrs.
        wa_kunn2-parvw = 'ZC'.
        APPEND wa_kunn2 TO i_kunn2.
      ENDIF.
      CLEAR: wa_itab.
    ENDLOOP.
...
***** Add delete BSAD jika tidak sesuai dengan kdgrp & kvgr3.
    DELETE t_bsad_add WHERE NOT ( kdgrp IN so_kdgrp ).
    DELETE t_bsad_add WHERE NOT ( kvgr3 IN so_kvgr3 ).
...
FORM f_gabung .
  ...
  SORT i_itab_sap BY bukrs vkbur zuonr kunnr.
  SORT i_kunn2 BY vkorg kunnr.
  SORT i_pernr BY vkorg kunn2.
  LOOP AT i_itab_sap INTO wa_itab.
...
*    ENDIF.
    READ TABLE i_kunn2 INTO wa_kunn2 WITH KEY kunnr = wa_itab-kunnr
                                      parvw = 'ZC'
                                      vkorg = pa_bukrs

    BINARY SEARCH.
    IF sy-subrc EQ 0.
      wa_itab-xref1 = wa_kunn2-kunn2.
      wa_itab-kunn2 = wa_kunn2-kunn2.
      READ TABLE i_pernr INTO wa_pernr    WITH KEY kunnr = wa_itab-kunn2
                                        parvw = 'ZP'
                                        vkorg = pa_bukrs
...
FORM f_gabung_real .
  CLEAR: va_dmbtr.
  SORT i_itab_sap BY bukrs kunnr.
  SORT i_kunn2 BY  vkorg kunnr.
  SORT i_pernr BY  vkorg kunn2.
...
FORM f_target_sales .
  ...
  IF r_vksap[] IS NOT INITIAL.
    SELECT a~spmon  a~pkunwe a~kvgr2 d~kdgrp a~vkbur a~waerk a~value a~ztop
                 c~name1 c~brsch d~kvgr3                           "b~kunn2
...
*      -->P_LD_TOTAL_ACT  text
*----------------------------------------------------------------------*
FORM f_cetak_subtotal_area  USING    p_ld_areanm
                                     p_ld_total_tgt
                                     p_ld_total_act.
  DATA: ld_persen TYPE p DECIMALS 4.

  IF p_ld_total_tgt IS INITIAL.
    ld_persen = 0.
  ELSE.
    ld_persen = p_ld_total_act / p_ld_total_tgt * 100.
  ENDIF.
  c1 = 1.
  WRITE: /  sy-vline. c1 = c1 + 1.
  WRITE AT c1(w1) ''. c1 = c1 + w1.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w2) p_ld_areanm. c1 = c1 + w2.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  SET LEFT SCROLL-BOUNDARY.
  WRITE AT c1(w3) p_ld_total_tgt. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) p_ld_total_act. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) ld_persen DECIMALS 2. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = 1.
  WRITE: /  sy-vline. c1 = c1 + 1.
  WRITE AT c1(w1) ''. c1 = c1 + w1.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w2) ''. c1 = c1 + w2.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  SET LEFT SCROLL-BOUNDARY.
  WRITE AT c1(w3) ''. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) ''. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) ''. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = 0.
ENDFORM.                    " F_CETAK_SUBTOTAL_AREA

*&---------------------------------------------------------------------*
*&      Form  F_CETAK_SUBTOTAL_GSBER
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*      -->P_LD_BRCHNM  text
*      -->P_LD_TOTAL_TGT1  text
*      -->P_LD_TOTAL_ACT1  text
*----------------------------------------------------------------------*
FORM f_cetak_subtotal_gsber  USING    p_ld_brchnm
                                      p_ld_total_tgt1
                                      p_ld_total_act1.
  DATA: ld_persen TYPE p DECIMALS 4.

  CONCATENATE 'Total' p_ld_brchnm INTO p_ld_brchnm SEPARATED BY space.
  IF p_ld_total_tgt1 IS INITIAL.
    ld_persen = 0.
  ELSE.
    ld_persen = p_ld_total_act1 / p_ld_total_tgt1 * 100.
  ENDIF.
  ...
  WRITE AT c1(w1) ''. c1 = c1 + w1.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w2) p_ld_brchnm. c1 = c1 + w2.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  SET LEFT SCROLL-BOUNDARY.
  WRITE AT c1(w3) p_ld_total_tgt1. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) p_ld_total_act1. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  WRITE AT c1(w3) ld_persen DECIMALS 2. c1 = c1 + w3.
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = 1.
  ...
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = 0.
ENDFORM.                    " F_CETAK_SUBTOTAL_GSBER

*&---------------------------------------------------------------------*
*&      Form  F_CETAK_SUBTOTAL_KOSONG
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*  -->  p1        text
...
FORM f_cetak_subtotal_kosong .
  ...
  WRITE AT c1(1) sy-vline NO-GAP. c1 = c1 + 1.
  c1 = 0.
ENDFORM.                    " F_CETAK_SUBTOTAL_KOSONG
...
*----------------------------------------------------------------------*
FORM f_proses8 .
  DATA: ld_valuetot LIKE t_result20-value,
        ld_pyvaltot LIKE t_result20-pyval,
        ld_sw(1),
        lt_zuonr    TYPE t_itab OCCURS 0 WITH HEADER LINE,
        lt_itabdo   TYPE t_itab OCCURS 0 WITH HEADER LINE.

  APPEND LINES OF i_itab TO lt_zuonr.
  APPEND LINES OF i_itab_real TO lt_zuonr.
  DELETE lt_zuonr WHERE zuonr = space.
  SORT lt_zuonr BY zuonr.
  DELETE ADJACENT DUPLICATES FROM lt_zuonr COMPARING zuonr.

  SELECT bukrs gsber budat bldat gjahr belnr kunnr blart zbd1t zfbdt
         zuonr dmbtr shkzg xref1 xref2 blart zterm
    INTO CORRESPONDING FIELDS OF TABLE lt_itabdo
    FROM bsid
    FOR ALL ENTRIES IN lt_zuonr
    WHERE bukrs EQ pa_bukrs       AND
          kunnr EQ lt_zuonr-kunnr AND
          zuonr EQ lt_zuonr-zuonr AND
          blart IN ('RV','ZA').

  SELECT bukrs gsber budat bldat gjahr belnr kunnr blart zbd1t zfbdt
         zuonr dmbtr shkzg xref1 xref2 blart zterm
    APPENDING CORRESPONDING FIELDS OF TABLE lt_itabdo
    FROM bsad
    FOR ALL ENTRIES IN lt_zuonr
    WHERE bukrs EQ pa_bukrs       AND
          kunnr EQ lt_zuonr-kunnr AND
  ...
  SORT lt_zuonr BY vkbur.
  DELETE ADJACENT DUPLICATES FROM lt_zuonr COMPARING vkbur.
  SELECT * INTO TABLE gt_tvkbt
    FROM tvkbt FOR ALL ENTRIES IN lt_zuonr
    WHERE spras EQ sy-langu
      AND vkbur EQ lt_zuonr-vkbur.

  IF t_result20[] IS INITIAL.
    IF pa_targe EQ 'X'.
      SORT i_itab BY zuonr blart.
      SORT lt_itabdo BY zuonr.
      SORT lt_zuonr BY zuonr.
      CLEAR: wa_itab, wa_result,t_result20.
      LOOP AT i_itab INTO wa_itab.
        CLEAR: lt_zuonr,lt_itabdo,gt_tvkbt.
        READ TABLE lt_itabdo WITH KEY zuonr = wa_itab-zuonr BINARY SEARCH.
        READ TABLE gt_tvkbt WITH KEY vkbur = wa_itab-vkbur.
        t_result20-vkbur = wa_itab-vkbur.
        t_result20-bezei = gt_tvkbt-bezei.
        t_result20-zuonr = wa_itab-zuonr.
        t_result20-bldat = lt_itabdo-bldat.
        t_result20-budat = lt_itabdo-bldat + lt_itabdo-zbd1t.
        t_result20-augdt = lt_itabdo-augdt.
        t_result20-kdgrp = wa_itab-kdgrp.
        t_result20-kunnr = wa_itab-kunnr.
        t_result20-name1 = wa_itab-name1.
        t_result20-waerk = wa_itab-waerk.
        PERFORM f_hitung.
        t_result20-value = wa_result-week1 + wa_result-week2 +
                           wa_result-week3 + wa_result-week4 +
                           wa_result-week5 + wa_result-sales1.
        COLLECT t_result20.
        CLEAR: t_result20,wa_result.
      ENDLOOP.
    ENDIF.

    IF pa_real EQ 'X'.
      SORT i_itab_real BY zuonr.
      SORT lt_itabdo BY zuonr.
      CLEAR: wa_itab_real,wa_result20,t_result20_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        CLEAR: lt_itabdo,gt_tvkbt.
        READ TABLE lt_itabdo WITH KEY zuonr = wa_itab_real-zuonr
            BINARY SEARCH.
        READ TABLE gt_tvkbt WITH KEY vkbur = wa_itab_real-vkbur.
*        t_result20-vkbur = wa_itab_real-vkbur.
*        t_result20-bezei = gt_tvkbt-bezei.
        t_result20_real-vkbur = wa_itab_real-vkbur.
        t_result20_real-bezei = gt_tvkbt-bezei.
        t_result20_real-zuonr = wa_itab_real-zuonr.
        t_result20_real-bldat = lt_itabdo-bldat.
        t_result20_real-budat = lt_itabdo-bldat + lt_itabdo-zbd1t.
        t_result20_real-augdt = lt_itabdo-augdt.
        t_result20_real-kdgrp = wa_itab_real-kdgrp.
        t_result20_real-kunnr = wa_itab_real-kunnr.
        t_result20_real-name1 = wa_itab_real-name1.
        t_result20_real-waerk = wa_itab_real-waerk.
        t_result20_real-pydat = wa_itab_real-budat.
        PERFORM f_hitung_real.
        t_result20_real-pyval = ( wa_result_real-week1 + wa_result_real-week2 +
                                  wa_result_real-week3 + wa_result_real-week4 +
                                  wa_result_real-week5 + wa_result_real-sales1 ) * -1.
        COLLECT t_result20_real.
        READ TABLE t_result20 WITH KEY kunnr = wa_itab_real-kunnr
                                       zuonr = wa_itab_real-zuonr.
        IF sy-subrc NE 0.
          t_result20 = t_result20_real.
          COLLECT t_result20.
        ENDIF.
        CLEAR: t_result20,t_result20_real,wa_result_real,wa_itab_real.
      ENDLOOP.
    ENDIF.
  ENDIF.

* cetak
  CLEAR: ld_valuetot,ld_pyvaltot.
  SORT t_result20 BY vkbur kunnr zuonr.
  SORT t_result20_real BY vkbur kunnr zuonr pydat.

  LOOP AT t_result20.
*    AT NEW name1.
*      ld_sw = '1'.
    WRITE: / sy-vline,
         (4) t_result20-vkbur, sy-vline,
        (20) t_result20-bezei, sy-vline,
        (10) t_result20-kunnr, sy-vline,
        (35) t_result20-name1, sy-vline.
*    ENDAT.
...
*          (10) '', sy-vline,
*          (35) '', sy-vline,
*          (12) t_result20-zuonr, sy-vline,
*          (10) t_result20-bldat, sy-vline,
*          (10) t_result20-budat, sy-vline,
*          (15) t_result20-value DECIMALS 0, sy-vline.
*    ELSE.
    WRITE: 84(12) t_result20-zuonr, sy-vline,
             (10) t_result20-bldat, sy-vline,
             (10) t_result20-budat, sy-vline,
             (15) t_result20-value DECIMALS 0, sy-vline.
*    ENDIF.
    ADD t_result20-value TO ld_valuetot.
*    CLEAR ld_sw.

* Cetak realization with DN
    LOOP AT t_result20_real WHERE kunnr = t_result20-kunnr AND
                                  zuonr = t_result20-zuonr.
      IF ld_sw IS INITIAL.
        WRITE: 143(10) t_result20_real-pydat, sy-vline,
                  (15) t_result20_real-pyval DECIMALS 0, sy-vline.
      ELSE.
        WRITE: / sy-vline,
             (4) t_result20-vkbur, sy-vline,
            (20) t_result20-bezei, sy-vline,
            ...
            (10) t_result20-budat, sy-vline,
            (15) '', sy-vline,
            (10) t_result20_real-pydat, sy-vline,
            (15) t_result20_real-pyval DECIMALS 0, sy-vline.
      ENDIF.
      ADD t_result20_real-pyval TO ld_pyvaltot.
      ld_sw = '1'.
    ENDLOOP.
    IF sy-subrc NE 0.
      WRITE: (10) '', sy-vline,
...
* Cetak realization without DN
*    LOOP AT t_result20_real WHERE kunnr = t_result20-kunnr.
*      read table t_result20 with key kunnr = t_result20_real-kunnr
*                                     zuonr = t_result20_real-zuonr.
*      IF sy-subrc = 0.
*        continue.
*      endif.
*      IF ld_sw IS INITIAL.
...
*            (10) '', sy-vline,
*            (35) '', sy-vline,
*            (12) t_result20_real-zuonr, sy-vline,
*            (10) t_result20_real-bldat, sy-vline,
*            (10) t_result20_real-budat, sy-vline,
*            (15) t_result20_real-value DECIMALS 0, sy-vline,
*            (10) t_result20_real-pydat, sy-vline,
*            (15) t_result20_real-pyval DECIMALS 0, sy-vline.
*      ELSE.
*        WRITE: / sy-vline,
...
*    ENDLOOP.
  ...
  WRITE: / sy-uline(172).
  WRITE: / sy-vline,
        17 'G R A N D  T O T A L',
       123 sy-vline,
      (15) ld_valuetot DECIMALS 0, sy-vline,
      (10) '', sy-vline,
      (15) ld_pyvaltot DECIMALS 0, sy-vline.
  WRITE: / sy-uline(172).
  PERFORM footer.
ENDFORM.                                                    " F_PROSES8

*&---------------------------------------------------------------------*
*&      Form  F_WRITE_HEADER_COLUMN8
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*  -->  p1        text
...
FORM f_write_header_column8 .
  WRITE: / sy-uline(172).
  WRITE: / sy-vline,
       (4) 'SlOf' CENTERED, sy-vline,
      (20) 'Sales Office' CENTERED, sy-vline,
      (10) 'Customer' CENTERED, sy-vline,
      (35) 'Customer Name' CENTERED, sy-vline,
      (12) 'DN No' CENTERED, sy-vline,
      (10) 'Tgl DN' CENTERED, sy-vline,
      (10) 'Due Date' CENTERED, sy-vline,
      (15) 'DN Value' CURRENCY 'IDR', sy-vline,
      (10) 'Pay Date', sy-vline,
      (15) 'Pay Value' CURRENCY 'IDR', sy-vline.
  WRITE: / sy-uline(172).
ENDFORM.                    " F_WRITE_HEADER_COLUMN8
...
FORM f_proses10 .
  DATA: l_vkbur LIKE i_delete-vkbur,
        ld_sw(1),
        lt_tvv3t LIKE tvv3t OCCURS 0 WITH HEADER LINE.
  ...
  IF lt_tvv3t[] IS INITIAL.
    SELECT * INTO TABLE lt_tvv3t
     FROM tvv3t
  ...
  IF i_result101[] IS INITIAL.
    IF i_result10[] IS INITIAL.
      SORT i_itab BY bukrs kvgr3 vkbur.
      CLEAR: wa_itab, wa_result, i_result10.
      LOOP AT i_itab INTO wa_itab.
        ON CHANGE OF wa_itab-bukrs OR
                     wa_itab-kvgr3 OR
                     wa_itab-vkbur.
          IF wa_result-kvgr3 NE space.
            ...
            wa_result-total_r = wa_result-week1 + wa_result-week2 +
                                wa_result-week3 + wa_result-week4 +
                                wa_result-week5 + wa_result-sales1.
            APPEND wa_result TO i_result10.
            CLEAR wa_result.
          ENDIF.
        ENDON.
        MOVE wa_itab-vkbur TO wa_result-vkbur.
...
*    IF pa_real EQ 'X'.
    IF i_result10_real[] IS INITIAL.
      SORT i_itab_real BY bukrs kvgr3 vkbur.
      CLEAR: wa_itab_real, wa_result_real, i_result10_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        ON CHANGE OF wa_itab_real-bukrs OR
                     wa_itab_real-kvgr3 OR
                     wa_itab_real-vkbur.
      ...
      IF wa_result_real-kvgr3 NE space.
        ...
        wa_result_real-total_r = wa_result_real-week1 +
                                 ...
                                 wa_result_real-week5 +
                                 wa_result_real-sales1.
        APPEND wa_result_real TO i_result10_real.
        CLEAR wa_result_real.
      ENDIF.
    ENDIF.
*      i_delete[] = i_result4_real[].
*    ENDIF.
    ...
    IF i_result101[] IS INITIAL.
      LOOP AT lt_tvv3t .
        CLEAR: i_result101.
        i_result101-bukrs = pa_bukrs.
        i_result101-kvgr3 = lt_tvv3t-kvgr3.
        LOOP AT i_result10 INTO wa_result WHERE bukrs = i_result101-bukrs AND
                                                kvgr3 = i_result101-kvgr3.
          CLEAR: i_result101-target.
          i_result101-vkbur = wa_result-vkbur.
          i_result101-target = wa_result-total_r.
          COLLECT i_result101.
          CLEAR: i_result101-target.
        ENDLOOP.
        LOOP AT i_result10_real INTO wa_result WHERE bukrs = i_result101-bukrs AND
                                                     kvgr3 = i_result101-kvgr3.
          CLEAR: i_result101-actual.
          i_result101-vkbur = wa_result-vkbur.
          i_result101-actual = wa_result-total_r.
          COLLECT i_result101.
          CLEAR: i_result101-actual.
        ENDLOOP.
      ENDLOOP.
...
* cetak
  SORT i_result101 BY bukrs kvgr3 vkbur.
  LOOP AT i_result101.
    AT NEW kvgr3.
      CLEAR lt_tvv3t.
      READ TABLE lt_tvv3t WITH KEY kvgr3 = i_result101-kvgr3.
      CONCATENATE i_result101-kvgr3 lt_tvv3t-bezei
        INTO va_text SEPARATED BY '-'.
      va_texttotal2 = va_text.
    ENDAT.
    ...
    AT NEW vkbur.
      SELECT SINGLE *  FROM tvkbt
        WHERE vkbur EQ i_result101-vkbur AND
            ( spras EQ 'EN' OR spras EQ 'E' ).
      CONCATENATE i_result101-vkbur tvkbt-bezei
        INTO l9_text SEPARATED BY '-'.
    ENDAT.

    i_result101-actual = i_result101-actual * -1.
    IF i_result101-target EQ 0.
      i_result101-persen = 0.
    ELSE.
      i_result101-persen = i_result101-actual / i_result101-target * 100.
    ENDIF.
    WRITE:/ '|', va_text(30), '|',
            l9_text(30), '|',
            i_result101-target ROUND va_round, '|',
            i_result101-actual ROUND va_round, '|',
            i_result101-persen DECIMALS 2, '|'.
    CLEAR va_text.

    AT END OF kvgr3.
      SUM.
      i_result101-actual = ABS( i_result101-actual ).
      IF i_result101-target EQ 0.
        i_result101-persen = 0.
      ELSE.
        i_result101-persen = i_result101-actual / i_result101-target * 100.
...
*----------------------------------------------------------------------*
FORM f_get_pernr .
  DATA: li_kunn2 TYPE t_kunn2 OCCURS 0 WITH HEADER LINE.
  SORT i_kunn2 BY kunnr vkorg.

  DELETE ADJACENT DUPLICATES FROM i_kunn2  COMPARING ALL FIELDS.

  li_kunn2[] = i_kunn2[].
  REFRESH: i_kunn2.
  CLEAR: i_kunn2.
  SELECT kunnr vkorg parvw kunn2 INTO TABLE i_kunn2
             FROM knvp
             FOR ALL ENTRIES IN li_kunn2
             WHERE kunnr = li_kunn2-kunnr AND
                   parvw EQ li_kunn2-parvw  AND
                   vkorg EQ li_kunn2-vkorg.
  IF sy-subrc EQ 0.

    IF li_kunn2[] IS NOT INITIAL.
      DELETE ADJACENT DUPLICATES FROM li_kunn2  COMPARING ALL FIELDS.
      SELECT kunnr kunn2 vkorg parvw pernr INTO  TABLE i_pernr FROM knvp
             FOR ALL ENTRIES IN i_kunn2
             WHERE kunnr = i_kunn2-kunn2 AND
                   parvw = 'ZP' AND
                   vkorg = i_kunn2-vkorg.
    ENDIF.
  ENDIF.
...
FORM f_write_header_column9 .
  ...
  CASE 'X'.
    WHEN radio23.
      WRITE: 187(20) 'DN principal', sy-vline.
      WRITE: / sy-uline(208).
    WHEN OTHERS.
      WRITE: / sy-uline(185).
  ENDCASE.

ENDFORM.                    " F_WRITE_HEADER_COLUMN9

*&---------------------------------------------------------------------*
*&      Form  F_PROSES82
*&---------------------------------------------------------------------*
FORM f_proses82 .
  DATA: ld_valuetot     LIKE t_result22-value,
        ld_pyvaltot     LIKE t_result22-pyval,
        ld_sw(1),
        lt_zuonr        TYPE t_itab OCCURS 0 WITH HEADER LINE,
        ls_zuonr        LIKE LINE OF lt_zuonr,
        lt_itabdo       TYPE t_itab OCCURS 0 WITH HEADER LINE,
        lt_vbrk         TYPE STANDARD TABLE OF vbrk INITIAL SIZE 0,
        lt_zsl_hsales   TYPE STANDARD TABLE OF zsl_hsales INITIAL SIZE 0,
        ls_zsl_hsales   LIKE LINE OF lt_zsl_hsales,
        ls_vbrk         LIKE LINE OF lt_vbrk,
        lv_zuonr        TYPE bsid-zuonr,
        lv_vbeln        TYPE zsl_hsales-vbeln.
  ...
  SORT lt_zuonr BY zuonr.
  DELETE ADJACENT DUPLICATES FROM lt_zuonr COMPARING zuonr.
  LOOP AT lt_zuonr INTO ls_zuonr.
    PERFORM f_modify_zuonr CHANGING ls_zuonr-zuonr.
    ls_zuonr-vbeln  = ls_zuonr-zuonr.
    MODIFY lt_zuonr FROM ls_zuonr TRANSPORTING zuonr vbeln.
    CLEAR ls_zuonr.
  ENDLOOP.

  PERFORM f_modify_itab TABLES lt_zuonr.
  ...
  IF lt_itabdo[] IS NOT INITIAL.
    SELECT vbeln fkart zuonr
      FROM vbrk
      INTO CORRESPONDING FIELDS OF TABLE lt_vbrk
      FOR ALL ENTRIES IN lt_itabdo
      WHERE vbeln = lt_itabdo-belnr
        AND fkart IN s_fkart.

    LOOP AT lt_vbrk INTO ls_vbrk.
      READ TABLE lt_itabdo WITH KEY belnr = ls_vbrk-vbeln.
      IF sy-subrc = 0.
        ls_vbrk-gjahr   = lt_itabdo-budat(4).
        MODIFY lt_vbrk FROM ls_vbrk TRANSPORTING gjahr.
      ENDIF.
    ENDLOOP.
  ENDIF.

  IF lt_zuonr[] IS NOT INITIAL.
    SELECT vbeln gjahr fkart
      FROM zsl_hsales
      INTO CORRESPONDING FIELDS OF TABLE lt_zsl_hsales
      FOR ALL ENTRIES IN lt_zuonr
      WHERE vkorg = pa_bukrs
        AND vkbur IN so_gsber
        AND vbeln = lt_zuonr-vbeln
        AND fkart IN s_fkart.

    LOOP AT lt_zsl_hsales INTO ls_zsl_hsales.
      ls_vbrk-vbeln = ls_zsl_hsales-vbeln.
      ls_vbrk-fkart = ls_zsl_hsales-fkart.
      ls_vbrk-zuonr = ls_zsl_hsales-vbeln.
      ls_vbrk-gjahr = ls_zsl_hsales-gjahr.
  ...
  IF t_result22[] IS INITIAL.
    IF pa_targe EQ 'X'.
      SORT i_itab BY zuonr blart.
      SORT lt_itabdo BY zuonr.
      SORT lt_zuonr BY zuonr.
      CLEAR: wa_itab, wa_result,t_result22.
      LOOP AT i_itab INTO wa_itab.
        CLEAR: lt_zuonr,lt_itabdo,gt_tvkbt.
        lv_zuonr = wa_itab-zuonr.
        PERFORM f_modify_zuonr CHANGING lv_zuonr.
        READ TABLE lt_itabdo WITH KEY zuonr = lv_zuonr BINARY SEARCH.
        READ TABLE gt_tvkbt WITH KEY vkbur = wa_itab-vkbur.
        t_result22-vkbur = wa_itab-vkbur.
        t_result22-bezei = gt_tvkbt-bezei.
        t_result22-zuonr = wa_itab-zuonr.
        t_result22-bldat = lt_itabdo-bldat.
        t_result22-budat = lt_itabdo-bldat + lt_itabdo-zbd1t.
        t_result22-augdt = lt_itabdo-augdt.
        t_result22-kdgrp = wa_itab-kdgrp.
        t_result22-kunnr = wa_itab-kunnr.
        t_result22-name1 = wa_itab-name1.
        t_result22-waerk = wa_itab-waerk.
        t_result22-xbudat = lt_itabdo-budat.
        t_result22-anln1 = wa_itab-anln1.

        PERFORM f_hitung.
        t_result22-value = wa_result-week1 + wa_result-week2 +
                           wa_result-week3 + wa_result-week4 +
                           wa_result-week5 + wa_result-sales1.
        COLLECT t_result22.
        CLEAR: t_result22,wa_result.
      ENDLOOP.
    ENDIF.
    ...
    IF pa_real EQ 'X'.
      SORT i_itab_real BY zuonr.
      SORT lt_itabdo BY zuonr.
      CLEAR: wa_itab_real,wa_result22,t_result22_real.
      LOOP AT i_itab_real INTO wa_itab_real.
        CLEAR: lt_itabdo,gt_tvkbt.
        READ TABLE lt_itabdo WITH KEY zuonr = wa_itab_real-zuonr
            BINARY SEARCH.
        READ TABLE gt_tvkbt WITH KEY vkbur = wa_itab_real-vkbur.
        t_result22_real-vkbur = wa_itab_real-vkbur.
        t_result22_real-bezei = gt_tvkbt-bezei.
        t_result22_real-zuonr = wa_itab_real-zuonr.
        t_result22_real-bldat = lt_itabdo-bldat.
        t_result22_real-budat = lt_itabdo-bldat + lt_itabdo-zbd1t.
        t_result22_real-augdt = lt_itabdo-augdt.
        t_result22_real-kdgrp = wa_itab_real-kdgrp.
        t_result22_real-kunnr = wa_itab_real-kunnr.
        t_result22_real-name1 = wa_itab_real-name1.
        t_result22_real-waerk = wa_itab_real-waerk.
        t_result22_real-pydat = wa_itab_real-budat.
        t_result22_real-xbudat = lt_itabdo-budat.
        t_result22_real-anln1 = wa_itab_real-anln1.

        PERFORM f_hitung_real.
        t_result22_real-pyval = ( wa_result_real-week1 + wa_result_real-week2 +
                                  wa_result_real-week3 + wa_result_real-week4 +
                                  wa_result_real-week5 + wa_result_real-sales1 ) * -1.
        COLLECT t_result22_real.
        READ TABLE t_result22 WITH KEY kunnr = wa_itab_real-kunnr
                                       zuonr = wa_itab_real-zuonr.
        IF sy-subrc NE 0.
          t_result22 = t_result22_real.
          COLLECT t_result22.
        ENDIF.
        CLEAR: t_result22,t_result22_real,wa_result_real,wa_itab_real.
      ENDLOOP.
    ENDIF.
  ENDIF.
...
* Validasi FKART
  LOOP AT t_result22.
    CLEAR ls_vbrk.
    READ TABLE lt_vbrk INTO ls_vbrk WITH KEY zuonr = t_result22-zuonr
                                             gjahr = t_result22-xbudat(4).
    IF sy-subrc = 0.
      IF ls_vbrk-fkart IN s_fkart.
        CONTINUE.
      ELSE.
        DELETE t_result22.
      ENDIF.
  ...
  LOOP AT t_result22_real.
    CLEAR ls_vbrk.
    READ TABLE lt_vbrk INTO ls_vbrk WITH KEY zuonr = t_result22_real-zuonr
                                             gjahr = t_result22_real-xbudat(4).
    IF sy-subrc = 0.
      IF t_result22_real-fkart IN s_fkart.
        CONTINUE.
      ELSE.
        DELETE t_result22_real.
      ENDIF.
    ELSE.
      IF s_fkart[] IS NOT INITIAL.
        DELETE t_result22_real.
...
* cetak
  CLEAR: ld_valuetot,ld_pyvaltot.
  SORT t_result22 BY vkbur kunnr zuonr.
  SORT t_result22_real BY vkbur kunnr zuonr pydat.
  ...
  LOOP AT t_result22.
    ...
    READ TABLE lt_vbrk INTO ls_vbrk WITH KEY zuonr = t_result22-zuonr
                                             gjahr = t_result22-xbudat(4).
    IF sy-subrc = 0.
      t_result22-fkart  = ls_vbrk-fkart.
    ENDIF.

    WRITE: / sy-vline,
         (4) t_result22-vkbur, sy-vline,
        (20) t_result22-bezei, sy-vline,
        (10) t_result22-kunnr, sy-vline,
        (35) t_result22-name1, sy-vline.

* Cetak target
    WRITE: 84(12) t_result22-zuonr, sy-vline,
             (10) t_result22-bldat, sy-vline,
             (10) t_result22-budat, sy-vline,
             (15) t_result22-value DECIMALS 0, sy-vline.
    ADD t_result22-value TO ld_valuetot.

* Cetak realization with DN
    LOOP AT t_result22_real WHERE kunnr = t_result22-kunnr AND
                                  zuonr = t_result22-zuonr.
      CLEAR ls_vbrk.
      READ TABLE lt_vbrk INTO ls_vbrk WITH KEY zuonr = t_result22_real-zuonr
                                               gjahr = t_result22_real-xbudat(4).
      IF sy-subrc = 0.
      ...
      IF ld_sw IS INITIAL.
        WRITE: 143(10) t_result22_real-pydat, sy-vline,
                  (15) t_result22_real-pyval DECIMALS 0, sy-vline,
                  (10) t_result22-fkart, sy-vline.

        IF radio23 = 'X'.
          WRITE: 187(20) t_result22-anln1, sy-vline.
        ENDIF.
      ...
      ELSE.
        WRITE: / sy-vline,
            ...
            (10) t_result22-kunnr, sy-vline,
            (35) t_result22-name1, sy-vline,
            (12) t_result22-zuonr, sy-vline,
            (10) t_result22-bldat, sy-vline,
            (10) t_result22-budat, sy-vline,
            (15) '', sy-vline,
            (10) t_result22_real-pydat, sy-vline,
            (15) t_result22_real-pyval DECIMALS 0, sy-vline,
            (10) t_result22-fkart, sy-vline.
        ...
        ENDIF.
      ENDIF.
      ADD t_result22_real-pyval TO ld_pyvaltot.
      ld_sw = '1'.
    ENDLOOP.
...
*&      Form  F_MODIFY_ZUONR
*&---------------------------------------------------------------------*
FORM f_modify_zuonr  CHANGING fc_zuonr.
  DATA : lv_length   TYPE i.

  lv_length = STRLEN( fc_zuonr ).
  lv_length = lv_length - 1.
  IF lv_length > 0.
    IF fc_zuonr+lv_length(1) = 'R'.
      fc_zuonr = fc_zuonr(lv_length).
    ENDIF.
  ENDIF.
ENDFORM.                    " F_MODIFY_ZUONR
...
*&      Form  F_MODIFY_ITAB
*&---------------------------------------------------------------------*
FORM f_modify_itab  TABLES   ft_xitab LIKE i_itab.
  DATA : lt_itab    TYPE STANDARD TABLE OF t_itab,
         ls_xitab   TYPE t_itab,
         ls_itab    TYPE t_itab.

  lt_itab[] = i_itab[].
  DELETE lt_itab WHERE anln1 = space.

  LOOP AT ft_xitab INTO ls_xitab.
    READ TABLE lt_itab INTO ls_itab
                       WITH KEY zuonr = ls_xitab-zuonr.
    IF sy-subrc = 0.
      MODIFY i_itab FROM ls_itab
                    TRANSPORTING anln1
                    WHERE zuonr = ls_xitab-zuonr.
    ENDIF.
  ENDLOOP.
...
*                       WITH KEY zuonr = ls_xitab-zuonr.
*    IF sy-subrc = 0.
*      MODIFY i_itab_real FROM ls_itab
*                         TRANSPORTING anln1
*                         WHERE zuonr = ls_xitab-zuonr.
*    ENDIF.
*  ENDLOOP.
