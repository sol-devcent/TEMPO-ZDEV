...
***SELECT-OPTIONS: s_kunn2 FOR knvp-kunn2 OBLIGATORY.
PARAMETERS:     p_pernr TYPE pernr_d MODIF ID crt, "OBLIGATORY
                p_datum TYPE dats DEFAULT sy-datum MODIF ID dta. "OBLIGATORY
SELECT-OPTIONS: s_pernr FOR zssutdt025-pernr MODIF ID dsp ,
                s_datum FOR zssutdt025-sdate MODIF ID dtb , " NO INTERVALS NO-EXTENSION,
                s_dcp FOR zssutdt025-daily_call_num MODIF ID bb1." NO INTERVALS NO-EXTENSION.
