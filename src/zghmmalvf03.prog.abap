...
FORM f_build_fieldcat TABLES ft_report.
  ...
  PERFORM f_fieldcatg USING ft_report:
   'WERKS' 'MARD' 'WERKS' '' '' '' '' '' '' '' '' '' '' ''
   'X' '' '' '' '',
   'NAME1' 'T001W' 'NAME1' '' '' 'Plant Description' '' '' '' '' '' ''
   '' '' 'X' '' '' '' '',
   'MEINS' 'MARA' 'MEINS' '' '3' '' '' '' '' '' '' '' '' ''
   'X''' '' '' '' '',
   ...
   '' '' '' '' '' '',
   'OPNSTO' '' '' '' '15' 'Open STO/DN' '' '' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   'OPNPO' '' '' '' '15' 'Open PO' '' '' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   'GRSTO' '' '' '' '15' 'GR PO/STO' '' '' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   'TOTPO' '' '' '' '15' 'Total PO/STO' '' 'X' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   'AVRSL' '' '' '' '15' 'Average Sales' '' '' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   'AVRSLUTD' '' '' '' '15' 'AvrgSls.United' '' '' '2' '' '' '' 'MEINS'
   '' '' '' '' '' '',
   ...
   '' '' '' '' '' '',
   'TACM' '' '' '' '23' 'Tot. Allo. Curr. Month' '' '' '2' '' ''
   '' 'MEINS' '' '' '' '' '' 'C300',
   'TANM' '' '' '' '21' 'Tot. Allo. Next Month' '' '' '2' '' '' ''
 'MEINS' '' '' '' '' '' 'C300'.
...
FORM f_user_command USING fu_ucomm LIKE sy-ucomm
  ...
  CASE fu_ucomm.
    ...
    WHEN '&IC1'.
      ...
      IF fu_selfield-sel_tab_field EQ 'I_MAIN-STKCR' OR
      ...
      ELSEIF ( fu_selfield-sel_tab_field EQ 'I_MAIN-TOTPO' OR
             fu_selfield-sel_tab_field EQ '1-TOTPO' ) AND
             d_flag NE 0.
        SUBMIT rm06em00 WITH SELECTION-TABLE seltab
           AND RETURN.
      ELSEIF ( fu_selfield-sel_tab_field EQ 'I_MAIN-INTRS' OR
        ...
        SUBMIT rm06em00 WITH SELECTION-TABLE seltab
           AND RETURN.
      ELSEIF ( fu_selfield-sel_tab_field EQ 'I_MAIN-OPNSTO' OR
        ...
        SUBMIT rm06em00 WITH SELECTION-TABLE seltab
           AND RETURN.
      ELSEIF ( fu_selfield-sel_tab_field EQ 'I_MAIN-GRSTO' OR
        ...
        SUBMIT rm06em00 WITH SELECTION-TABLE seltab
           AND RETURN.
      ELSEIF ( fu_selfield-sel_tab_field EQ 'I_MAIN-AVRSL' OR
        ...
        SUBMIT zs_sac7_2 WITH SELECTION-TABLE seltab
           AND RETURN.
      ENDIF.
  ENDCASE.
...
FORM f_init_path .
  IF sy-opsys = 'AIX'.
    p_path = '/interface/Alokasi/'.
  ELSE.
    p_path = '\\tdsdev01\interface\Alokasi\'.
  ENDIF.
ENDFORM.                    " F_INIT_PATH
...
FORM f_download_server .
  DATA: lt_download TYPE truxs_t_text_data,
        ls_download TYPE LINE OF truxs_t_text_data,
        lr_descr    TYPE REF TO cl_abap_structdescr,
        lw_comp     TYPE abap_compdescr.

  DATA: lv_field_index TYPE sytabix.

  FIELD-SYMBOLS: <fs_download>  LIKE i_download,
                 <fs_fldval>    TYPE ANY.
...
* Convert itab to string
  ...
  LOOP AT i_main.
    AT FIRST.
      APPEND INITIAL LINE TO i_download ASSIGNING <fs_download>.
      DO.
        lv_field_index = sy-index.
        ASSIGN COMPONENT lv_field_index OF STRUCTURE <fs_download> TO <fs_fldval>.
        IF sy-subrc <> 0.
          ls_download = <fs_download>.
        ...
        ELSE.
          CASE lv_field_index.
            WHEN 1.
              <fs_fldval> = 'Material'.
            WHEN 2.
              <fs_fldval> = 'Material Description'.
            WHEN 3.
              <fs_fldval> = 'Material Group'.
            WHEN 4.
              <fs_fldval> = 'Unit'.
            WHEN 5.
              <fs_fldval> = 'Plant'.
            WHEN 6.
              <fs_fldval> = 'Plant Description'.
            WHEN 7.
              <fs_fldval> = 'Total CW Alloc.'.
            WHEN 8.
              <fs_fldval> = 'Open DN'.
            WHEN 9.
              <fs_fldval> = 'Good Receipt'.
*            WHEN 9.
*              <fs_fldval> = 'Open PO'.
          ENDCASE.
        ENDIF.
      ENDDO.
    ENDAT.
    i_main-opnsto = ABS( i_main-opnsto ).
    MOVE-CORRESPONDING i_main TO i_download.
    ls_download = i_download.
    APPEND ls_download TO lt_download.
  ENDLOOP.

* Get filename
  CONCATENATE p_path sy-datum '.txt' INTO p_path.
