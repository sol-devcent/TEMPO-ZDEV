...
*            p_gjahr TYPE gjahr MODIF ID gja DEFAULT sy-datum(4),
            p_file  LIKE rlgrap-filename MODIF ID pfi.
*            p_kunnr TYPE zcodt017-kunnr MODIF ID pku,
*            p_stat  TYPE zcodt017-status MODIF ID pst,
...
AT SELECTION-SCREEN ON p_bukrs.
  IF p_bukrs = '8380'.
    MESSAGE 'Company Code 8380 is not allowed' TYPE 'E'.
  ENDIF.
