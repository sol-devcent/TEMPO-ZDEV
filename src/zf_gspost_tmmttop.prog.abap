...
DATA : gt_zfgsdntmmt LIKE zfgsdntmmt OCCURS 0 WITH HEADER LINE.
...
DATA: gt_head    LIKE zfstgsdn OCCURS 0 WITH HEADER LINE,
      ...
      gt_add     TYPE STANDARD TABLE OF zfgsdntmmt_add,
      gt_xadd    TYPE STANDARD TABLE OF zfgsdntmmt_add,
      gt_3       TYPE STANDARD TABLE OF zfgstmmt3.
