...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zm_auto_dn NO STANDARD PAGE HEADING
                  LINE-SIZE 255.
...
PARAMETERS pa_vbeln LIKE likp-vbeln MODIF ID vb1.
SELECT-OPTIONS so_vbeln FOR likp-vbeln MODIF ID vb2.
SELECT-OPTIONS so_erdat FOR likp-erdat MODIF ID erd.
PARAMETERS pa_anzpk LIKE likp-anzpk MODIF ID anz DEFAULT 1.
