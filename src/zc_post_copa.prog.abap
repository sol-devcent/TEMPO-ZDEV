...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zc_post_copa NO STANDARD PAGE HEADING
                    LINE-SIZE 255.
...
PARAMETERS pa_monat   TYPE monat OBLIGATORY DEFAULT sy-datum+4(2).
SELECTION-SCREEN SKIP 1.
PARAMETERS pa_check AS CHECKBOX DEFAULT 'X' MODIF ID chk.
...
START-OF-SELECTION.
  ...
  IF pa_check IS INITIAL.
    PERFORM f_post_entries USING 'X'.
  ELSE.
