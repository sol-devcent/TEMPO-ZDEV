REPORT ZS_UPLOAD_PO_B2B_RAMAYANA NO STANDARD PAGE HEADING MESSAGE-ID 00
                                 LINE-SIZE 170.
...
PARAMETERS: p_path(125) DEFAULT '\\tdsdev01\interface\B2B\ramayana' LOWER CASE,
            p_start(10),
...
*}   REPLACE
    ...
    CONCATENATE v_logfile '/' sy-datum(4) '/' sy-datum+4(2) '/rmy' INTO v_logfile.
  ELSE.
...
*qty_b(10),
      ...
      REPLACE ',' WITH ' ' INTO wa_itab_d-price.
      REPLACE ',' WITH ' ' INTO wa_itab_d-price.
      CONDENSE wa_itab_d-price NO-GAPS.
      REPLACE ',' WITH ' ' INTO wa_itab_d-net.
      REPLACE ',' WITH ' ' INTO wa_itab_d-net.
      CONDENSE wa_itab_d-net NO-GAPS.
      REPLACE ',' WITH ' ' INTO wa_itab_d-total.
      REPLACE ',' WITH ' ' INTO wa_itab_d-total.
      CONDENSE wa_itab_d-total NO-GAPS.

      i_zsd_b2b-meins = i_matb2b-vrkme.
      i_zsd_b2b-netwr = wa_itab_d-total.
      i_zsd_b2b-kzwi1 = wa_itab_d-price.
      i_zsd_b2b-waers = 'IDR'.
...
** Move To itab Update
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_purchase.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_purchase.
      CONDENSE wa_itab_t-tot_purchase NO-GAPS.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_aft_disc.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_aft_disc.
      CONDENSE wa_itab_t-tot_aft_disc NO-GAPS.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_disc.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_disc.
      CONDENSE wa_itab_t-tot_disc NO-GAPS.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_ppn.
      REPLACE ',' WITH ' ' INTO wa_itab_t-tot_ppn.
      CONDENSE wa_itab_t-tot_ppn NO-GAPS.

      i_zsh_b2b-netwr = 0.
      i_zsh_b2b-tdisa = wa_itab_t-tot_disc.
      i_zsh_b2b-brtwr = wa_itab_t-tot_purchase.
      i_zsh_b2b-mwsbk = 0.
*      i_zsh_b2b-netwr = wa_itab_t-tot_purchase.
*      i_zsh_b2b-tdisa = wa_itab_t-tot_disc.
*      i_zsh_b2b-brtwr = wa_itab_t-tot_aft_ppn.
*      i_zsh_b2b-mwsbk = wa_itab_t-tot_ppn.
      i_zsh_b2b-netwr = i_zsh_b2b-netwr / 100.
      i_zsh_b2b-tdisa = i_zsh_b2b-tdisa / 100.
      i_zsh_b2b-brtwr = i_zsh_b2b-brtwr / 100.
