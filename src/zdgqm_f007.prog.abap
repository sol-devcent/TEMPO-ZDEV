...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zdgqm_f007 NO STANDARD PAGE HEADING
                      LINE-SIZE 255.
...
PARAMETERS pa_qmnum   LIKE qmel-qmnum.
SELECTION-SCREEN END OF BLOCK data.

SELECTION-SCREEN BEGIN OF SCREEN 110 TITLE TEXT-110.
PARAMETERS: pa_qam TYPE ad_namtext OBLIGATORY,
            pa_pm  TYPE ad_namtext OBLIGATORY.
...
AT SELECTION-SCREEN ON VALUE-REQUEST FOR pa_qam.
  PERFORM f_get_sign USING '03' CHANGING pa_qam.

AT SELECTION-SCREEN ON VALUE-REQUEST FOR pa_pm.
  PERFORM f_get_sign USING '04' CHANGING pa_pm.
