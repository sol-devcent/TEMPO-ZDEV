...
*&                                                                     *
*&---------------------------------------------------------------------*
REPORT zm_release_dn NO STANDARD PAGE HEADING
                     LINE-SIZE 255.
...
"SELECT-OPTIONS so_lfart FOR likp-lfart.
SELECT-OPTIONS so_vbeln FOR likp-vbeln.
SELECT-OPTIONS so_erdat FOR likp-erdat DEFAULT sy-datum MODIF ID erd.
SELECTION-SCREEN END OF BLOCK data.

SELECTION-SCREEN BEGIN OF BLOCK process WITH FRAME TITLE text-002.
PARAMETERS p_rel RADIOBUTTON GROUP grp1 USER-COMMAND grp1.
PARAMETERS p_doc RADIOBUTTON GROUP grp1.
