  ...
  METHOD handle_double_click.
    ...
    CASE e_column.
      WHEN 'TKNUM'.
        ...
        IF sy-subrc = 0.
          SET PARAMETER ID 'TNR' FIELD ls_out-tknum.
      ...
      WHEN 'BELNR'.
        ...
        IF sy-subrc = 0.
          ...
          SET PARAMETER ID 'BUK' FIELD ls_out-bukrsx.
      ...
      WHEN 'BELNRREV'.
        READ TABLE gt_out INTO ls_out INDEX e_row-index.
        IF sy-subrc = 0.
          SET PARAMETER ID 'BLN' FIELD ls_out-belnrrev.
          SET PARAMETER ID 'BUK' FIELD ls_out-bukrsx.
          SET PARAMETER ID 'GJR' FIELD ls_out-gjahr.
          CALL TRANSACTION 'FB03' AND SKIP FIRST SCREEN.
        ENDIF.
      ...
      WHEN 'VBELN'.
        READ TABLE gt_out INTO ls_out INDEX e_row-index.
        IF sy-subrc = 0.
          SET PARAMETER ID 'VF' FIELD ls_out-vbeln.
